...
angular
  .module('emission.plugin.kvstore', [
  ...
  .factory(
    'KVStore',
    function ($window, Logger, localStorageService, $ionicPopup, $ionicPlatform, ClientStats) {
      var logger = Logger;
      var kvstoreJs = {};
      /*
      ...
      var getUnifiedValue = function (key) {
        ...
        return getNativePlugin()
          .getLocalStorage(key, false)
          .then(function (uc_stored_val) {
            logger.log(
              'for key ' +
                key +
                ' uc_stored_val = ' +
            ...
            if (angular.equals(ls_stored_val, uc_stored_val)) {
              ...
              if (ls_stored_val == null) {
                ...
                return getNativePlugin()
                  .putLocalStorage(key, ls_stored_val)
                  .then(function () {
     ...
     */
      ...
      let syncAllWebAndNativeValues = function () {
        ...
        const syncKeys = getNativePlugin()
          ...
          .then((nativeKeys) => {
            ...
            logger.log(
              'STORAGE_PLUGIN: Found web keys ' + foundWeb + ' missing web keys ' + missingWeb,
            );
        ...
        const listAllKeys = getNativePlugin()
          .listAllUniqueKeys()
          .then((nativeKeys) => {
