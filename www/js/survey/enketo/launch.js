...
angular
  .module('emission.survey.enketo.launch', [
    'emission.services',
  ...
  .factory('EnketoSurveyLaunch', function ($ionicPopup, EnketoSurvey, $ionicModal) {
    ...
    function launch(scope, name, opts) {
      ...
      return new Promise(function (resolve, reject) {
        $ionicModal
          .fromTemplateUrl('templates/survey/enketo/modal.html', { scope })
          .then((modal) => {
            _state.modal = modal;
