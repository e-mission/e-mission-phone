...
angular
  .module('emission.survey.enketo.trip.button', ['emission.survey.enketo.answer'])
  .factory('EnketoTripButtonService', function (EnketoSurveyAnswer, Logger, $timeout) {
     ...
     */
    etbs.extractResult = (results) =>
      EnketoSurveyAnswer.filterByNameAndVersion('TripConfirmSurvey', results);
