    ...
    function (
      ...
      $rootScope.$on(
        ...
        function (event, toState, toParams, fromState, fromParams) {
          ...
          ClientStats.addReading(
            ClientStats.getStatKeys().STATE_CHANGED,
            fromState.name + '-2-' + toState.name,
          ).then(
            function () {},
            function () {},
          );
      ...
      $rootScope.$on(
        ...
        function (event, toState, toParams, fromState, fromParams, error) {
          ...
          ClientStats.addError(
            ClientStats.getStatKeys().STATE_CHANGED,
            fromState.name + '-2-' + toState.name + '_' + error,
          ).then(
            function () {},
            function () {},
          );
      ...
      $rootScope.$on('$stateNotFound', function (event, unfoundState, fromState, fromParams) {
        ...
        ClientStats.addError(
          ClientStats.getStatKeys().STATE_CHANGED,
          fromState.name + '-2-' + unfoundState.name,
        ).then(
          function () {},
          function () {},
        );
