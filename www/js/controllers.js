angular.module("emission.controllers", [
...
}).controller("SplashCtrl", function($state, $rootScope, 
    StartPrefs, ClientStats)  {
    console.log("SplashCtrl invoked");
    // alert("attach debugger!");
    // PushNotify.startupInit();

    $rootScope.$on("$stateChangeSuccess", function(_event, toState, _toParams, fromState, _fromParams){
    ...
    $rootScope.$on("$stateChangeError", function(_event, toState, _toParams, fromState, _fromParams, error){
    ...
    $rootScope.$on("$stateNotFound",
        function(_event, unfoundState, fromState, _fromParams){
    ...
    $rootScope.$on("$stateChangeStart",
        function(event, toState, _toParams, _fromState, _fromParams, _options){
            var personalTabs = [
                "root.main.common.map",
                "root.main.control",
                "root.main.metrics",
                "root.main.goals",
                "root.main.diary",
