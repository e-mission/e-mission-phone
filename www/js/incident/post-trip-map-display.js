...
.controller("PostTripMapCtrl", function($scope, $window, $state,
  ...
  */
  ...
  var checkIncidentTutorialDone = function () {
    var POST_TRIP_MODE_DONE_KEY = 'incident_tutorial_done';
    var incidentTutorialDone = KVStore.getDirect(POST_TRIP_MODE_DONE_KEY);
    if (!incidentTutorialDone) {
      startWalkthrough();
      KVStore.set(POST_TRIP_MODE_DONE_KEY, true);
    }
  };
