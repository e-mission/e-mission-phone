angular.module("emission.incident.posttrip.prompt", [
    "emission.plugin.logger",
]).factory("PostTripAutoPrompt", function(
    $window, $ionicPlatform, $rootScope, $state,
    $ionicPopup, Logger
) {
    var ptap = {};
    ...
    var cleanDataIfNecessary = function(notification, _state, _data) {
    ...
    var displayCompletedTrip = function(notification, _state, _data) {
    ...
    ptap.registerUserResponse = function() {
        ...
        $window.cordova.plugins.notification.local.on("clear", function (_notification, _state, _data) {
            // alert("notification cleared, no report");
        });
        $window.cordova.plugins.notification.local.on("cancel", function (_notification, _state, _data) {
