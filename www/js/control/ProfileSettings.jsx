    ...
    <>
      ...
      <ScrollView>
        ...
        <SettingRow
          ...
          iconName="check"
          action={() => setPermitVis(true)}></SettingRow>
        <SettingRow
      ...
      <Modal visible={consentVis} onDismiss={() => setConsentVis(false)} transparent={true}>
        <Dialog
          ...
          style={settingStyles.dialog(colors.elevation.level3)}>
          <Dialog.Title>
            {t('general-settings.consented-to', {
              protocol_id: consentDoc.protocol_id,
              approval_date: consentDoc.approval_date,
            })}
          </Dialog.Title>
          <Dialog.Actions>
            <Button
      ...
      <ControlCollectionHelper
        editVis={editCollection}
        setEditVis={setEditCollection}></ControlCollectionHelper>
    </>
  );
};
