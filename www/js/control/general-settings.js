angular.module("emission.main.control",[
    "emission.services",
    ...
    //     $ionicPopup.alert({
    //         template: "WATCH OUT! If there is unsynced data, you may lose it. If you want to keep the data, use 'Force Sync' before doing this"
    ...
    var handleNoConsent = function(_resultDoc) {
