angular.module("emission.main.common.place-detail",[
    "ui-leaflet",
    "emission.services",
]).controller("CommonPlaceDetailCtrl", function($scope, $stateParams, CommonGraph) {
    $scope.placeId = $stateParams.placeId;
    $scope.place = CommonGraph.data.cPlaceId2ObjMap[$scope.placeId];

    $scope.succ_trips_places = $scope.place.succ_places.map(function(sp, _index, _array) {
