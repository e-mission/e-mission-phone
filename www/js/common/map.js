angular.module("emission.main.common.map", [
    "emission.main.common.services",
    "emission.services",
    "emission.main.diary.helper.service",
    "nvd3",
]).controller("CommonMapCtrl", function (
    $scope, leafletMapEvents, CommonGraph, Config, DiaryHelper
) {
...
*/
    ...
    $scope.$on(CommonGraph.UPDATE_DONE, function (_event, _args) {
