angular.module("emission.main.common.trip-detail", [
    "ui-leaflet",
    "emission.services",
    "emission.main.common.services",
    "nvd3",
]).controller("CommonTripDetailCtrl", function ($scope, $stateParams, CommonGraph) {
    ...
    valsDuration = d3.layout.histogram().bins(nob).range([mMin, mMax])(distributionDuration);
