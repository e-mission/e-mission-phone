angular.module("emission.splash.referral", [
...
]).factory("ReferralHandler", function(_$window, KVStore) {
    var referralHandler = {};
    ...
    referralHandler.clearGroupReferral = function(_kvList) {
    ...
    referralHandler.getReferralParams = function(_kvList) {
