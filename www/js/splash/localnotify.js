...
angular.module("emission.splash.localnotify", [
    "emission.plugin.logger",
    "emission.splash.startprefs",
]).factory("LocalNotify", function(
    $window, $ionicPlatform, $ionicPopup,
   ...
   */
    ...
    localNotify.handleNotification = function(notification, state, _data) {
