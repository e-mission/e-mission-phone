angular.module("emission.splash.pushnotify", [
    "emission.plugin.logger",
    "emission.services",
    "emission.splash.startprefs",
]).factory("PushNotify", function(
    $window, $rootScope, $ionicPlatform,
    Logger, CommHelper, StartPrefs
) {
    ...
    var redirectSilentPush = function(_event, data) {
    ...
    $rootScope.$on(StartPrefs.INTRO_DONE_EVENT, function(_event, _data) {
