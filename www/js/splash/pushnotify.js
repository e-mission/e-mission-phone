...
angular
  .module('emission.splash.pushnotify', ['emission.plugin.logger', 'emission.services'])
  .factory(
    'PushNotify',
    function ($window, $state, $rootScope, $ionicPlatform, $ionicPopup, Logger) {
      var pushnotify = {};
      var push = null;
      ...
      pushnotify.registerPromise = function () {
        return new Promise(function (resolve, reject) {
          ...
          push.on('registration', function (data) {
            ...
            resolve({ token: data.registrationId, type: data.registrationType });
          });
          ...
          .then(function (t) {
            ...
            return $window.cordova.plugins.BEMServerSync.getConfig()
              .then(
                ...
                function (error) {
                  console.log(
                    'Got error ' + error + ' while reading config, returning default = 3600',
                  );
                  return 3600;
                },
              )
      ...
      var redirectSilentPush = function (event, data) {
        ...
        pushnotify.datacollect
          .getConfig()
          .then(function (config) {
            if (config.ios_use_remote_push_for_sync) {
              pushnotify.datacollect.handleSilentPush().then(function () {
