angular.module("emission.main.heatmap",[
    "ui-leaflet",
    "emission.services",
    ...
    $scope.$on("leafletDirectiveMap.heatmap.resize", function(_event, data) {
   ...
   */
    ...
    $scope.showHeatmap = function(lnglat) {
        ...
        lnglat.forEach(function(cval, _i, _array) {
        ...
        var latlng = lnglat.map(function(cval, _i, _array){
            return cval.reverse();
        });
   ...
   */
    ...
    $scope.changeMode = function() {
        $ionicActionSheet.show({
            ...
            cancelText: "Cancel",
            buttonClicked: function(_index, button) {
   ...
   */
    ...
    $scope.showIncidents = function(incidentEntries) {
        ...
        incidentFeatureList.forEach(function(ival, _i, _array) {
