...
angular
  .module('emission.main.metrics.mappings', [
  ...
  .factory(
    'CustomDatasetHelper',
    function (METDatasetHelper, Logger, $ionicPlatform, DynamicConfig) {
      var cdh = {};
      ...
      $ionicPlatform.ready().then(function () {
        DynamicConfig.configReady().then((newConfig) => cdh.init(newConfig));
      });
