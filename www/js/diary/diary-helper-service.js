angular.module("emission.main.diary.helper.service", [
    ...
    dh.average = function (array) {
        ...
        var sum = array.reduce(function (previousValue, currentValue, _currentIndex, _array) {
    ...
    dh.showModes = function (section) {
        return function () {
            ...
            dh.userModes.forEach(function (item, _index, _array) {
                if (item != currMode) {
    ...
    var style_stop = function (_feature) {
