...
export function useTripAddressNames(trip: CompositeTrip | UnprocessedTrip) {
...
export function usePlaceAddressName(place: ConfirmedPlace) {
...
export const useAddressNames = (tlEntry: TimelineEntry): string[] =>
  isTrip(tlEntry) ? useTripAddressNames(tlEntry) : usePlaceAddressName(tlEntry);
