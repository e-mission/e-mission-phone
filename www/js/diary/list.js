...
angular.module("emission.main.diary.list", [
    ...
    ionicDatePicker,
    Timeline, CommonGraph, DiaryHelper,
    Config, PostTripManualMarker, ConfirmHelper, nzTour,
    KVStore, Logger, $ionicPopover
) {
    ...
    $scope.$on("leafletDirectiveMap.resize", function(_event, data) {
    ...
    */
    ...
    $scope.$on(Timeline.UPDATE_DONE, function(_event, args) {
        ...
        $scope.$apply(function() {
            ...
            $scope.data.currDayTrips.forEach(function(trip, _index, _array) {
    ...
    $scope.$on(CommonGraph.UPDATE_DONE, function(_event, args) {
        ...
        $scope.$apply(function() {
            ...
            if (!angular.isUndefined($scope.data) && !angular.isUndefined($scope.data.currDayTripWrappers)) {
                $scope.data.currDayTripWrappers.forEach(function(tripWrapper, _index, _array) {
    ...
    */
    ...
    var startWalkthrough = function () {
        nzTour.start(tour).then(function (_result) {
