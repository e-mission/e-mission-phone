          ...
          if (forcedNav) {
            ...
            if (tmp && switchToView.historyId !== tmp.historyId) {
              ...
              viewIds.forEach(function (viewId) {
                ...
                if (
                  view.backViewId === switchToView.viewId &&
                  view.historyId !== switchToView.historyId
                ) {
  ...
  IonicModule.provider('$ionicConfig', function () {
    ...
    provider.transitions.views.ios = function (enteringEle, leavingEle, direction, shouldAnimate) {
      function setStyles(ele, opacity, x, boxShadowOpacity) {
        ...
        if (boxShadowOpacity > -1) {
          css.boxShadow =
            '0 0 10px rgba(0,0,0,' + (d.shouldAnimate ? boxShadowOpacity * 0.45 : 0.3) + ')';
        }
    ...
    provider.transitions.navBar.ios = function (
      ...
      function enter(ctrlA, ctrlB, step) {
        ...
        var backTextX =
          (ctrlB && (ctrlB.titleTextX() - ctrlA.backButtonTextLeft()) * (1 - step)) || 0;
      ...
      function leave(ctrlA, ctrlB, step) {
        if (!ctrlA || !ctrlB) return;
        var titleX =
          (-(ctrlA.titleTextX() - ctrlB.backButtonTextLeft()) - ctrlA.titleLeftRight()) * step;
  ...
  IonicModule.factory('$ionicModal', [
    ...
    function (
      ...
      var createModal = function (templateString, options) {
        ...
        // Compile the template
        var element = $compile(
          '<ion-' + options.viewType + '>' + templateString + '</ion-' + options.viewType + '>',
        )(scope);
          ...
          var self = {
            ...
            hardwareBackButtonClick: function (e) {
              ...
              for (actionId in self.$backButtonActions) {
                if (
                  !priorityAction ||
                  self.$backButtonActions[actionId].priority >= priorityAction.priority
                ) {
 ...
 */
        ...
        function onRelease(ev) {
          if (isPrimary && viewTransition && dragPoints && dragPoints.length > 1) {
            ...
            if (isSwipingRight && (releaseSwipeCompletion > 0.5 || velocity > 0.1)) {
              ...
              var speed =
                velocity > 0.5 || velocity < 0.05 || releaseX > windowWidth - 45 ? 'fast' : 'slow';
  ...
  */
      ...
      self.isDraggableTarget = function (e) {
        ...
        var startX =
          e.gesture.startEvent && e.gesture.startEvent.center && e.gesture.startEvent.center.pageX;
  ...
  IonicModule.controller('$ionicTab', [
    ...
    function ($scope, $ionicHistory, $attrs, $location, $state) {
      ...
      this.hrefMatchesState = function () {
        return (
          $attrs.href &&
          $location.path().indexOf($attrs.href.replace(/^#/, '').replace(/\/$/, '')) === 0
        );
      };
  ...
  IonicModule.controller('$ionicView', [
    ...
    function ($scope, $element, $attrs, $compile, $rootScope) {
      ...
      function afterEnter() {
        ...
        var viewTitleAttr =
          (isDefined($attrs.viewTitle) && 'viewTitle') || (isDefined($attrs.title) && 'title');
        if (viewTitleAttr) {
  ...
  function CollectionRepeatDirective(
    ...
    function postLink(scope, element, attr, scrollCtrl, transclude) {
      ...
      function onResize() {
        if (
          changeValidator.resizeRequiresRefresh(scrollView.__clientWidth, scrollView.__clientHeight)
        ) {
          refreshDimensions();
        }
      }
      ...
      function getRepeatManager() {
        return (
          ...
          (repeatManager = new $ionicCollectionManager({
            ...
            widthData: widthData,
            forceRefreshImages: !!(
              isDefined(attr.forceRefreshImages) && attr.forceRefreshImages !== 'false'
            ),
    ...
    return function RepeatController(options) {
      ...
      this.refreshLayout = function () {
        ...
        var firstStyle =
          ...
          {};
        var lastStyle =
          (afterItemsNode.lastElementChild && getComputedStyle(afterItemsNode.lastElementChild)) ||
          {};
        repeaterAfterSize =
        ...
        containerNode.style[ionic.CSS.TRANSFORM] = TRANSLATE_TEMPLATE_STR.replace(
          PRIMARY,
          -beforeMargin,
        ).replace(SECONDARY, 0);
      ...
      function VerticalViewType() {
        ...
        this.refreshDirection = function () {
          ...
          this.estimatedItemsAcross =
            (isGridView && Math.floor(scrollView.__clientWidth / estimatedWidth)) || 1;
        };
      }
      function HorizontalViewType() {
        ...
        this.refreshDirection = function () {
          ...
          this.estimatedItemsAcross =
            (isGridView && Math.floor(scrollView.__clientHeight / estimatedHeight)) || 1;
        };
      }
      ...
      function StaticViewType() {
        ...
        this.updateRenderRange = function (scrollValue, scrollValueEnd) {
          ...
          renderAfterBoundary =
            this.getEstimatedPrimaryPos(renderEndIndex) + this.estimatedPrimarySize;
        };
      }
      ...
      function DynamicViewType() {
        ...
        this.updateRenderRange = function (scrollValue, scrollValueEnd) {
          ...
          renderBeforeBoundary =
            renderStartIndex !== -1 ? this.getDimensions(renderStartIndex).primaryPos : -1;
      ...
      return {
        ...
        compile: function (element, attr) {
          ...
          var nativeScrolling =
            ...
            (attr.overflowScroll === 'true' || !$ionicConfig.scrolling.jsScrolling());
  ...
  var GESTURE_DIRECTIVES =
    'onHold onTap onDoubleTap onTouch onRelease onDragStart onDrag onDragEnd onDragUp onDragRight onDragDown onDragLeft onSwipe onSwipeUp onSwipeRight onSwipeDown onSwipeLeft'.split(
      ' ',
    );
    ...
    function ($$rAF) {
      return {
        ...
        compile: function ($element, $attrs) {
          var isAnchor =
            isDefined($attrs.href) || isDefined($attrs.ngHref) || isDefined($attrs.uiSref);
          var isComplexItem =
            isAnchor ||
          ...
          if (!hasInnerText) {
            ...
            if (!hasButtonText && $ionicConfig.backButton.text()) {
              buttonTextEle.innerHTML +=
                '<span class="default-title">' + $ionicConfig.backButton.text() + '</span>';
            }
        ...
        compile: function (element, attr) {
          ...
          function prelink($scope, $element, $attr, sideMenuCtrl) {
            ...
            var content = {
              ...
              setMarginLeftAndRight: ionic.animationFrameThrottle(
                function (amountLeft, amountRight) {
      ...
      return {
        ...
        compile: function (tElement) {
          ...
          tElement
            .append(innerElement)
            .addClass(
              'tabs-' + $ionicConfig.tabs.position() + ' tabs-' + $ionicConfig.tabs.style(),
            );
