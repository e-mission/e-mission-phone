...
!(function () {
  ...
  function i(e) {
    return 'submit' == e.target.type && 0 === e.detail
      ...
      ? (e.stopPropagation(), ionic.tap.isLabelWithTextInput(e.target) || e.preventDefault(), !1)
      : void 0;
  }
  function r(t) {
    return t.isIonicTap || p(t)
      ...
      ? (t.stopPropagation(),
        ionic.Platform.isEdge() ||
          ...
          t.preventDefault(),
        !1)
      : (($ = !1), (q = ionic.tap.pointerCoord(t)), e('mousemove'), void ionic.activator.start(t));
  }
  function a(n) {
    return B
      ...
      ? !1
      : (_(n) || t(n), e('mousemove', !1), ionic.activator.end(), void ($ = !1));
  }
  function o(t) {
    ...
    return (
      ...
      (ne = ionic.DomUtil.getParentWithClass(e.target, de))
        ? ((ee = e.target),
          ...
          void (ionic.keyboard.isOpen || V() ? ionic.keyboard.isOpen && I() : L(I, !0)))
  ...
  function D() {
    (ionic.keyboard.isLandscape = !ionic.keyboard.isLandscape),
      ...
      ionic.Platform.isAndroid() && (ionic.keyboard.isOpen && V() ? (le = !0) : L(O, !1));
  }
  function M(e) {
  ...
  function P() {
    clearTimeout(re),
      ...
      ionic.Platform.isAndroid() && (V() && cordova.plugins.Keyboard.close(), ee && ee.blur()),
      (ee = null),
      (te = null);
  }
  function I() {
  ...
  function O() {
    (le = !1),
      (ae = G()),
      ionic.keyboard.isLandscape && !se ? (se = ae) : ionic.keyboard.isLandscape || oe || (oe = ae),
  ...
  function R() {
    ...
    if (he) {
      var t,
        n = he.content.toLowerCase().replace(/\s+/g, '').split(',');
  ...
  (window.ionic = window.ionic || {}),
      ...
      (e.CustomEvent = (function () {
        ...
        (e.EventController = {
          ...
          trigger: function (t, n, i, r) {
            ...
            (n && n.target && n.target.dispatchEvent && n.target.dispatchEvent(a)) ||
    ...
    (function (e) {
      ...
      (e.Gesture = function (t, n) {
        ...
        (e.Gestures = {}),
        (e.Gestures.defaults = { stop_browser_behavior: 'disable-user-behavior' }),
        ...
        (e.Gestures.NO_MOUSEEVENTS =
          e.Gestures.HAS_TOUCHEVENTS && window.navigator.userAgent.match(e.Gestures.MOBILE_REGEX)),
        ...
        (e.Gestures.Instance.prototype = {
          ...
          trigger: function (t, n) {
            ...
            var r = this.element;
            return (
              e.Gestures.utils.hasParent(n.target, r) && (r = n.target), r.dispatchEvent(i), this
            );
          },
          enable: function (e) {
      ...
      (e.Gestures.event = {
        ...
        onTouch: function (t, a, o) {
          ...
          this.bindDom(t, e.Gestures.EVENT_TYPES[a], function (l) {
            ...
            if (!c.match(/mouse/) || !r) {
              c.match(/touch/) || c.match(/pointerdown/) || (c.match(/mouse/) && 1 === l.which)
                ? (i = !0)
              ...
              i &&
                ...
                (d || null === n) && (n = l),
                o.call(e.Gestures.detection, s.collectEventData(t, a, s.getTouchList(n, a), l)),
                e.Gestures.HAS_POINTEREVENTS &&
                  a == e.Gestures.EVENT_END &&
                  (d = e.Gestures.PointerEvent.updatePointer(a, l))),
                d || ((n = null), (i = !1), (r = !1), e.Gestures.PointerEvent.reset());
            }
          });
        },
        determineEventTypes: function () {
          ...
          (t = e.Gestures.HAS_POINTEREVENTS
            ...
            : ['touchstart mousedown', 'touchmove mousemove', 'touchend touchcancel mouseup']),
          ...
          updatePointer: function (t, n) {
            return (
              t == e.Gestures.EVENT_END
                ? (this.pointers = {})
                : ((n.identifier = n.pointerId), (this.pointers[n.pointerId] = n)),
        ...
        (e.Gestures.gestures.Tap = {
          ...
          handler: function (t, n) {
            if (t.eventType == e.Gestures.EVENT_END && 'touchcancel' != t.srcEvent.type) {
              ...
              i &&
                'tap' == i.name &&
                t.timeStamp - i.lastEvent.timeStamp < n.options.doubletap_interval &&
                t.distance < n.options.doubletap_distance &&
                (n.trigger('doubletap', t), (r = !0)),
                (!r || n.options.tap_always) &&
                  ((e.Gestures.detection.current.name = 'tap'), n.trigger('tap', t));
            }
          },
        }),
          ...
          handler: function (t, n) {
            if (t.eventType == e.Gestures.EVENT_END) {
              if (n.options.swipe_max_touches > 0 && t.touches.length > n.options.swipe_max_touches)
                return;
              (t.velocityX > n.options.swipe_velocity || t.velocityY > n.options.swipe_velocity) &&
                (n.trigger(this.name, t), n.trigger(this.name + t.direction, t));
            }
          },
        }),
              ...
              ('touchstart' == t.srcEvent.type || 'touchend' == t.srcEvent.type
                ...
                : this.preventedFirstMove ||
                  ...
                  (n.options.prevent_default_directions.length > 0 &&
                    -1 != n.options.prevent_default_directions.indexOf(t.direction) &&
                ...
                case e.Gestures.EVENT_MOVE:
                  ...
                  t.drag_locked_to_axis &&
                    ...
                    (e.Gestures.utils.isVertical(r)
                      ? (t.direction =
                          t.deltaY < 0 ? e.Gestures.DIRECTION_UP : e.Gestures.DIRECTION_DOWN)
                      : (t.direction =
                          t.deltaX < 0 ? e.Gestures.DIRECTION_LEFT : e.Gestures.DIRECTION_RIGHT)),
                    this.triggered || (n.trigger(this.name + 'start', t), (this.triggered = !0)),
                    n.trigger(this.name, t),
                    n.trigger(this.name + t.direction, t),
                    ((n.options.drag_block_vertical && e.Gestures.utils.isVertical(t.direction)) ||
                ...
                case e.Gestures.EVENT_MOVE:
                  ...
                  (e.Gestures.detection.current.name = this.name),
                    ...
                    i > n.options.transform_min_scale &&
                      (n.trigger('pinch', t), n.trigger('pinch' + (t.scale < 1 ? 'in' : 'out'), t));
                  break;
                case e.Gestures.EVENT_END:
                  this.triggered && n.trigger(this.name + 'end', t), (this.triggered = !1);
              }
        ...
        (e.Gestures.gestures.Touch = {
          ...
          handler: function (t, n) {
            return n.options.prevent_mouseevents && t.pointerType == e.Gestures.POINTER_MOUSE
              ? void t.stopDetect()
      ...
      var s,
        ...
        f = (n.Platform = {
          ...
          setPlatform: function (e) {
            m =
              'undefined' != typeof e && null !== e && e.length
                ...
                ? l
                : (f.navigator.platform && navigator.platform.toLowerCase().split(' ')[0]) || '';
          },
          version: function () {
          ...
          setVersion: function (e) {
            ...
            n[t] &&
              ((e = f.ua.match(n[t])), e && e.length > 2 && (g = parseFloat(e[1] + '.' + e[2])));
          },
          is: function (e) {
            if (((e = e.toLowerCase()), f.platforms))
              for (var t = 0; t < f.platforms.length; t++) if (f.platforms[t] === e) return !0;
            var n = f.platform();
              ...
              f.ready(function () {
                h(function () {
                  f._showStatusBar
                    ...
                    : (e.StatusBar && e.StatusBar.hide(), t.body.classList.add('status-bar-hide'));
                });
              });
          },
    ...
    (function (e, t) {
      ...
      (t.CSS = {}),
        ...
        (function () {
          ...
          for (
            i = ['webkitTransition', 'mozTransition', 'msTransition', 'transition'], n = 0;
            n < i.length;
            n++
          )
            if (void 0 !== e.documentElement.style[i[n]]) {
        ...
        (function () {
          ...
          window.navigator.pointerEnabled
            ? ((e = 'pointerdown'), (n = 'pointermove'), (i = 'pointerup'), (r = 'pointercancel'))
            : window.navigator.msPointerEnabled &&
              ((e = 'MSPointerDown'),
              (n = 'MSPointerMove'),
              (i = 'MSPointerUp'),
  ...
  (ionic.tap = {
    register: function (t) {
      return (
        ...
        e('mousedown'),
        window.navigator.pointerEnabled
          ? (e('pointerdown'), e('pointerup'), e('pointercancel'), (j = 'pointermove'))
          : window.navigator.msPointerEnabled
          ? (e('MSPointerDown'), e('MSPointerUp'), e('MSPointerCancel'), (j = 'MSPointerMove'))
    ...
    isTextInput: function (e) {
      return (
        ...
        ('TEXTAREA' == e.tagName ||
          ...
          ('INPUT' == e.tagName &&
            !/^(radio|checkbox|range|file|submit|reset|color|image|button)$/i.test(e.type)))
      );
    },
        ...
        ionic.requestAnimationFrame(function () {
          ...
          if (ionic.tap.isTextInput(t) && !ionic.tap.isDateInput(t)) {
            ...
            (n.value = t.value),
              ...
              (n.readOnly = !0),
              t.isContentEditable &&
                ((n.contentEditable = t.contentEditable), (n.innerHTML = t.innerHTML)),
  ...
  !(function (e) {
    ...
    me.effect.Animate = {
      requestAnimationFrame: (function () {
        ...
        if (
          (t &&
            !/requestAnimationFrame\(\)\s*\{\s*\[native code\]\s*\}/i.test(t.toString()) &&
            (n = !1),
          n)
        )
          return function (e, n) {
      ...
      start: function (e, o, s, l, c, d) {
        ...
        var _ = function (a) {
          ...
          if (g)
            for (var w = Math.round((v - p) / (i / n)) - 1, T = 0; T < Math.min(w, 4); T++)
              _(!0), f++;
          l && ((h = (v - u) / l), h > 1 && (h = 1));
          var b = c ? c(h) : h;
          (e(b, v, g) !== !1 && 1 !== h) || !g
            ? g && ((p = v), me.effect.Animate.requestAnimationFrame(_, d))
            : ((r[m] = null), s && s(n - f / ((v - u) / i), m, 1 === h || null == l));
        };
    ...
    (function (e) {
      ...
      (e.views.Scroll = e.views.View.inherit({
          ...
          (i.hintResize = e.debounce(
            ...
            (i.onScroll = function () {
              e.scroll.isScrolling
                ? (clearTimeout(i.scrollTimer), (i.scrollTimer = setTimeout(i.setScrollStop, 80)))
          ...
          if (
            ((i.scrollChildIntoView = function (t) {
              ...
              t.detail.isElementUnderKeyboard &&
                e.requestAnimationFrame(function () {
                  (r.scrollTop = 0),
                    i.isShrunkForKeyboard && !o && (a = r.getBoundingClientRect().bottom);
                  var s = 0.5 * n,
            ...
            (i.resetScrollView = function () {
              i.isShrunkForKeyboard &&
                ((i.isShrunkForKeyboard = !1), (r.style.height = ''), (r.style.overflow = '')),
                i.resize();
            }),
        ...
        __resizeScrollbars: function () {
          ...
          if (t.__indicatorY) {
            var i = Math.max(
              Math.round((t.__clientHeight * t.__clientHeight) / t.__contentHeight),
              20,
            );
            ...
            o.__indicatorY && (s = 10),
              ...
              o.__scrollLeft < 0
                ? ((t = Math.max(
                    ...
                    (o.__indicatorX.size - Math.abs(o.__scrollLeft)) / o.__indicatorX.size,
                  )),
                  (r = 0),
                  (o.__indicatorX.indicator.style[o.__transformOriginProperty] = 'left center'))
                : n > 0
                ? ((t = Math.max(
                    o.__indicatorX.minScale,
                  ...
                  (o.__indicatorX.indicator.style[o.__transformOriginProperty] = 'right center'))
                : ((r = Math.min(o.__maxScrollLeft, Math.max(0, r))), (t = 1));
            ...
            (a = Math.round(o.__indicatorY.sizeRatio * o.__scrollTop) || 0),
              ...
              o.__scrollTop < 0
                ? ((e = Math.max(
                    ...
                    (o.__indicatorY.size - Math.abs(o.__scrollTop)) / o.__indicatorY.size,
                  )),
                  (a = 0),
                  'center top' !== o.__indicatorY.originProp &&
                    ((o.__indicatorY.indicator.style[o.__transformOriginProperty] = 'center top'),
                ...
                ? ((e = Math.max(
                  ...
                  'center bottom' !== o.__indicatorY.originProp &&
                    ((o.__indicatorY.indicator.style[o.__transformOriginProperty] =
                      'center bottom'),
        ...
        __fadeScrollbars: function (e, t) {
          ...
          if (n.options.scrollbarsFade) {
            ...
            n.options.scrollbarsFade === !0 &&
              ...
              'in' == e
                ? (n.__indicatorX && n.__indicatorX.indicator.classList.remove(i),
                  n.__indicatorY && n.__indicatorY.indicator.classList.remove(i))
          ...
          return (
            ...
            o.style[s] !== r
              ? function (e, i, r, a) {
                  ...
                  o !== t.contentTransform && ((n.style[l] = o), (t.contentTransform = o)),
                    t.__repositionScrollbars(),
                    a || t.triggerScrollEvent();
                }
              : o.style[l] !== r
              ? function (e, i, r, a) {
                  (n.style[l] = 'translate(' + -e + 'px,' + -i + 'px) scale(' + r + ')'),
                    t.__repositionScrollbars(),
                    a || t.triggerScrollEvent();
                }
              : function (e, i, r, a) {
        ...
        zoomTo: function (e, t, n, i) {
          ...
          r.__isDecelerating &&
            (me.effect.Animate.stop(r.__isDecelerating), (r.__isDecelerating = !1));
          var a = r.__zoomLevel;
        ...
        scrollTo: function (e, t, n, i, r) {
          ...
          if (
            (a.__isDecelerating &&
              (me.effect.Animate.stop(a.__isDecelerating), (a.__isDecelerating = !1)),
          ...
          a.options.scrollingX
            ? a.options.paging
              ...
              : a.options.snapping && (e = Math.round(e / a.__snapWidth) * a.__snapWidth)
            : (e = a.__scrollLeft),
            a.options.scrollingY
              ? a.options.paging
                ? (t = Math.round(t / a.__clientHeight) * a.__clientHeight)
                : a.options.snapping && (t = Math.round(t / a.__snapHeight) * a.__snapHeight)
              : (t = a.__scrollTop),
          ...
          if (i.__isTracking) {
            ...
            2 === e.length
              ? ((r = Math.abs(e[0].pageX + e[1].pageX) / 2),
                ...
                !n && i.options.zooming && (n = i.__getScale(i.__initialTouches, e)))
            ...
            if (i.__isDragging) {
              ...
              if (null != n && i.options.zooming) {
                ...
                if (
                  ((u = (u / i.__lastScale) * n),
                  (u = Math.max(Math.min(u, i.options.maxZoom), i.options.minZoom)),
                  p !== u)
                ) {
                    ...
                    ? ((d += (l / 2) * i.options.speedMultiplier),
                      i.__enableScrollX ||
                        ...
                        !i.__refreshActive && d <= -i.__refreshHeight
                          ? ((i.__refreshActive = !0), i.__refreshActivate && i.__refreshActivate())
                          : i.__refreshActive &&
                            d > -i.__refreshHeight &&
                            ((i.__refreshActive = !1),
              ...
              (i.__enableScrollX = i.options.scrollingX && w >= v),
                ...
                (i.__isDragging = (i.__enableScrollX || i.__enableScrollY) && (w >= _ || T >= _)),
            ...
            if (!i.__isDecelerating)
              if (i.__refreshActive && i.__refreshStart) {
                ...
                (i.__interruptedAnimation || i.__isDragging) && i.__scrollingComplete(),
                  ...
                  i.__refreshActive &&
                    ((i.__refreshActive = !1), i.__refreshDeactivate && i.__refreshDeactivate());
        ...
        __publish: function (e, t, r, a, o) {
          var s = this,
            l = s.__isAnimating;
          if (
            (l && (me.effect.Animate.stop(l), (s.__isAnimating = !1)), a && s.options.animating)
          ) {
            ...
            var c = s.__scrollLeft,
              ...
              m = function (e, t, n) {
                n &&
                  ...
                  (s.__scrollTop = d + h * e),
                  (s.__zoomLevel = u + f * e),
                  s.__callback && s.__callback(s.__scrollLeft, s.__scrollTop, s.__zoomLevel, o));
              },
              g = function (e) {
        ...
        __startDeceleration: function () {
          ...
          var o = function () {
              var t =
                Math.abs(e.__decelerationVelocityX) >= e.__minVelocityToKeepDecelerating ||
                Math.abs(e.__decelerationVelocityY) >= e.__minVelocityToKeepDecelerating;
              return (
                t ||
        ...
        __stepThroughDeceleration: function (e) {
          ...
          if (
            (e ? t.__publish(n, i, t.__zoomLevel) : ((t.__scrollLeft = n), (t.__scrollTop = i)),
            !t.options.paging)
          ) {
          ...
          if (t.options.bouncing) {
            ...
            if (
              (n < t.__minDecelerationScrollLeft
                ...
                : n > t.__maxDecelerationScrollLeft && (s = t.__maxDecelerationScrollLeft - n),
              i < t.__minDecelerationScrollTop
                ? (l = t.__minDecelerationScrollTop - i)
                : i > t.__maxDecelerationScrollTop && (l = t.__maxDecelerationScrollTop - i),
              0 !== s)
            ) {
      ...
      e.views.ScrollNative = e.views.View.inherit({
        initialize: function (t) {
          ...
          (n.__container = n.el = t.el),
            ...
            (n.__maxScrollTop = Math.max(n.__contentHeight - n.__clientHeight, 0)),
            (n.__maxScrollLeft = Math.max(n.__contentWidth - n.__clientWidth, 0)),
        ...
        scrollTo: function (t, n, i) {
          function r(t, n) {
            ...
            var l = Date.now(),
              ...
              u = a.el.scrollLeft;
            return d === t && u === n
              ? ((a.el.style.overflowX = o), (a.el.style.overflowY = s), void a.resize())
        ...
        __initEventHandlers: function () {
          ...
          (i.scrollChildIntoView = function (a) {
            ...
            i.__originalContainerHeight || (i.__originalContainerHeight = o.height),
                ...
                e.requestAnimationFrame(function () {
                  (t = Math.max(
                    ...
                    Math.min(
                      ...
                      i.__originalContainerHeight - (a.detail.keyboardHeight - 43),
                    ),
                  )),
                    (r.style.height = t + 'px'),
      ...
      (c.prototype = new l()),
        (c.prototype.start = function (a) {
          ...
          this.canSwipe() &&
            ...
            o &&
              ...
              (l =
                parseFloat(o.style[e.CSS.TRANSFORM].replace('translate3d(', '').split(',')[0]) ||
                0),
        ...
        (c.prototype.end = function (t, n) {
          ...
          t.gesture.deltaX > -(i._currentDrag.buttonsWidth / 2) &&
            ('left' == t.gesture.direction && Math.abs(t.gesture.velocityX) < 0.3
              ? (r = 0)
            ...
            e.requestAnimationFrame(function () {
              ...
              (i._currentDrag.content.style[e.CSS.TRANSITION] = ''),
                ...
                i._currentDrag &&
                  ((i._currentDrag.buttons = null), (i._currentDrag.content = null)),
                (i._currentDrag = null),
                n && n();
            });
        });
        ...
        (d.prototype.drag = e.animationFrameThrottle(function (t) {
          ...
          if (this._currentDrag) {
            ...
            !this._isDragging &&
              ...
              (this._isDragging = !0),
              this._isDragging && (this._moveElement(t), (this._currentDrag.currentY = i + r - a));
          }
        })),
          ...
          initialize: function (t) {
            ...
            (t = e.extend(
              ...
              !n.itemHeight &&
                n.listEl &&
                (n.itemHeight =
                  n.listEl.children[0] && parseInt(n.listEl.children[0].style.height, 10)),
          ...
          _startDrag: function (t) {
            ...
            n._didDragUpOrDown && r instanceof c && r.clean && r.clean(),
              ...
              ('up' != t.gesture.direction && 'down' != t.gesture.direction)
                ? !n._didDragUpOrDown &&
                  ('left' == t.gesture.direction || 'right' == t.gesture.direction) &&
                  Math.abs(t.gesture.deltaX) > 5 &&
                  ((i = n._getItem(t.target)),
                  i &&
                    i.querySelector('.item-options') &&
                    ((n._dragOp = new c({ el: n.el, item: i, canSwipe: n.canSwipe })),
                    n._dragOp.start(t),
                    t.preventDefault(),
      ...
      (e.views.SideMenu = e.views.View.inherit({
        ...
        (e.views.SideMenuContent = e.views.View.inherit({
          ...
          getTranslateX: function () {
            return parseFloat(
              this.el.style[e.CSS.TRANSFORM].replace('translate3d(', '').split(',')[0],
            );
          },
      ...
      e.views.Slider = e.views.View.inherit({
        initialize: function (e) {
            ...
            if (b.offsetWidth) {
              ...
              for (var t = S.length; t--; ) {
                ...
                (n.style.width = E + 'px'),
                  ...
                  T.transitions &&
                    ((n.style.left = t * -E + 'px'), o(t, M > t ? -E : t > M ? E : 0, 0));
              }
              e.continuous && T.transitions && (o(r(M - 1), -E, 0), o(r(M + 1), E, 0)),
            ...
            var r = +new Date(),
              a = setInterval(function () {
                ...
                return o > i
                  ...
                  : void (D.style.left = (n - t) * (Math.floor((o / i) * 100) / 100) + t + 'px');
              }, 4);
          }
          function c() {
            L = setTimeout(i, I);
          ...
          window.navigator.pointerEnabled
            ...
            : window.navigator.msPointerEnabled
            ? ((u = 'MSPointerDown'), (p = 'MSPointerMove'), (h = 'MSPointerUp'))
              ...
              z = {
                ...
                touchmove: function (t) {
                  if (
                    ...
                    (N = { x: n.pageX - k.x, y: n.pageY - k.y }),
                      'undefined' == typeof P && (P = !!(P || Math.abs(N.x) < Math.abs(N.y))),
                      P ||
                        (t.preventDefault(),
                        d(),
                        e.continuous
                          ...
                          : (e.bouncing
                              ? (N.x =
                                  N.x /
                                  ((!M && N.x > 0) || (M == S.length - 1 && N.x < 0)
                                    ? Math.abs(N.x) / E + 1
                                    : 1))
                              : (E * M - N.x < 0 && (N.x = Math.min(N.x, E * M)),
                                Math.abs(N.x) > E * (S.length - M - 1) &&
                                  (N.x = Math.max(-E * (S.length - M - 1), N.x))),
                            s(M - 1, N.x + y[M - 1], 0),
                            s(M, N.x + y[M], 0),
                            s(M + 1, N.x + y[M + 1], 0)),
                        e.onDrag && e.onDrag());
                ...
                transitionEnd: function (t) {
                  parseInt(t.target.getAttribute('data-index'), 10) == M &&
                    (I && c(), e.transitionEnd && e.transitionEnd.call(t, M, S[M]));
                },
              };
    ...
    (function () {
        ...
        n = function (e, r, a, o) {
            ...
            if (0 !== n) {
              if ((y.params.mousewheelInvert && (n = -n), y.params.freeMode)) {
                ...
                if (
                  ...
                  y.updateProgress(),
                  y.updateActiveIndex(),
                  ((!a && y.isBeginning) || (!o && y.isEnd)) && y.updateClasses(),
          ...
          if (
            ...
            (y.container[0].swiper = y),
              ...
              y.support.flexbox ||
                (y.classNames.push('swiper-container-no-flexbox'), (y.params.slidesPerColumn = 1)),
              ...
              ['cube', 'coverflow'].indexOf(y.params.effect) >= 0 &&
                (y.support.transforms3d
                  ? ((y.params.watchSlidesProgress = !0), y.classNames.push('swiper-container-3d'))
                ...
                function e() {
                  'undefined' != typeof y &&
                    ...
                    y.imagesLoaded === y.imagesToLoad.length &&
                      (y.params.updateOnImagesReady && y.update(), y.emit('onImagesReady', y)));
                }
              ...
              (y.startAutoplay = function () {
                return 'undefined' != typeof y.autoplayTimeoutId
                  ...
                  ? y.autoplaying
                    ? !1
                    : ((y.autoplaying = !0), y.emit('onAutoplayStart', y), void c())
                  : !1;
              }),
              ...
              (y.updateSlidesSize = function () {
                ...
                y.params.slidesPerColumn > 1 &&
                  ...
                  'auto' !== y.params.slidesPerView &&
                    ...
                    (a = Math.max(a, y.params.slidesPerView * y.params.slidesPerColumn)));
                var o,
                ...
                for (e = 0; e < y.slides.length; e++) {
                  ...
                  if (y.params.slidesPerColumn > 1) {
                    ...
                    'column' === y.params.slidesPerColumnFill
                      ...
                      p
                        .css({
                          'margin-top':
                            0 !== m && y.params.spaceBetween && y.params.spaceBetween + 'px',
                        })
                  ...
                  'none' !== p.css('display') &&
                    ('auto' === y.params.slidesPerView
                      ...
                      : ((o = (y.size - (y.params.slidesPerView - 1) * t) / y.params.slidesPerView),
                        y.params.roundLengths && (o = l(o)),
                        s()
                ...
                if (
                  (y.rtl &&
                    y.wrongRTL &&
                    ('slide' === y.params.effect || 'coverflow' === y.params.effect) &&
                    y.wrapper.css({ width: y.virtualSize + y.params.spaceBetween + 'px' }),
                  (!y.support.flexbox || y.params.setWrapperSize) &&
                    (s()
                      ? y.wrapper.css({ width: y.virtualSize + y.params.spaceBetween + 'px' })
                      : y.wrapper.css({ height: y.virtualSize + y.params.spaceBetween + 'px' })),
                  y.params.slidesPerColumn > 1 &&
                    ((y.virtualSize = (o + y.params.spaceBetween) * a),
                    (y.virtualSize =
                      Math.ceil(y.virtualSize / y.params.slidesPerColumn) - y.params.spaceBetween),
                    y.wrapper.css({ width: y.virtualSize + y.params.spaceBetween + 'px' }),
                    y.params.centeredSlides))
                ) {
              ...
              (y.updateActiveIndex = function () {
                ...
                for (t = 0; t < y.slidesGrid.length; t++)
                  'undefined' != typeof y.slidesGrid[t + 1]
                    ? i >= y.slidesGrid[t] &&
                      i < y.slidesGrid[t + 1] - (y.slidesGrid[t + 1] - y.slidesGrid[t]) / 2
                      ? (e = t)
                      : i >= y.slidesGrid[t] && i < y.slidesGrid[t + 1] && (e = t + 1)
              ...
              (y.updateClasses = function () {
                ...
                if (
                  ...
                  var n;
                  y.params.loop
                    ? ((n = Math.ceil(y.activeIndex - y.loopedSlides) / y.params.slidesPerGroup),
                      n > y.slides.length - 1 - 2 * y.loopedSlides &&
                        (n -= y.slides.length - 2 * y.loopedSlides),
                      n > y.bullets.length - 1 && (n -= y.bullets.length))
                    : (n = 'undefined' != typeof y.snapIndex ? y.snapIndex : y.activeIndex || 0),
                ...
                y.params.loop ||
                  (y.params.prevButton &&
                    (y.isBeginning
                      ? (t(y.params.prevButton).addClass(y.params.buttonDisabledClass),
                        y.params.a11y && y.a11y && y.a11y.disable(t(y.params.prevButton)))
                      : (t(y.params.prevButton).removeClass(y.params.buttonDisabledClass),
                        y.params.a11y && y.a11y && y.a11y.enable(t(y.params.prevButton)))),
                  y.params.nextButton &&
                    (y.isEnd
                      ? (t(y.params.nextButton).addClass(y.params.buttonDisabledClass),
                        y.params.a11y && y.a11y && y.a11y.disable(t(y.params.nextButton)))
                      : (t(y.params.nextButton).removeClass(y.params.buttonDisabledClass),
                ...
                if (
                  ...
                  for (
                    var e = '',
                      t = y.params.loop
                        ? Math.ceil(
                            (y.slides.length - 2 * y.loopedSlides) / y.params.slidesPerGroup,
                          )
                        : y.snapGrid.length,
                      n = 0;
                    t > n;
                ...
                if (
                  ...
                  y.controller && y.controller.spline && (y.controller.spline = void 0),
                    y.params.freeMode
                      ...
                      : ((n =
                          ('auto' === y.params.slidesPerView || y.params.slidesPerView > 1) &&
                          y.isEnd &&
                          !y.params.centeredSlides
                    ...
                    (a = t(y.clickedSlide).attr('data-swiper-slide-index')),
                      y.params.centeredSlides
                        ? o < y.loopedSlides - y.params.slidesPerView / 2 ||
                          o > y.slides.length - y.loopedSlides + y.params.slidesPerView / 2
                          ? (y.fixLoop(),
                            (o = y.wrapper
                              .children(
                                '.' +
            ...
            if (
                      ...
                      if (R || !y.browser.ieTouch) {
                        ...
                        if (
                            ...
                            ? ((a = !1),
                              y.params.resistance &&
                                (P =
                                  y.minTranslate() -
                                  1 +
                                  Math.pow(-y.minTranslate() + I + i, y.params.resistanceRatio)))
                            : 0 > i &&
                              P < y.maxTranslate() &&
                              ((a = !1),
                              y.params.resistance &&
                                (P =
                                  y.maxTranslate() +
                                  1 -
                                  Math.pow(y.maxTranslate() - I - i, y.params.resistanceRatio))),
                          ...
                          (y.params.freeMode || y.params.watchSlidesProgress) &&
                            ...
                            y.params.freeMode &&
                              (0 === G.length &&
                                G.push({ position: y.touches[s() ? 'startX' : 'startY'], time: C }),
                              G.push({
              ...
              (y.onTouchEnd = function (e) {
                if (
                  ...
                  if (
                    ...
                    !x || !D || !y.swipeDirection || 0 === y.touches.diff || P === I)
                  )
                    return void (x = D = !1);
                  x = D = !1;
                  var r;
                  if (
                    ((r = y.params.followFinger ? (y.rtl ? y.translate : -y.translate) : -P),
                    y.params.freeMode)
                  ) {
                    ...
                    if (y.params.freeModeMomentum) {
                      ...
                      if (u < y.maxTranslate())
                        y.params.freeModeMomentumBounce
                          ? (u + y.maxTranslate() < -f && (u = y.maxTranslate() - f),
                            (p = y.maxTranslate()),
                            (h = !0),
                            (z = !0))
                          : (u = y.maxTranslate());
                        ...
                        (u =
                          Math.abs(y.snapGrid[m] - u) < Math.abs(y.snapGrid[m - 1] - u) ||
                          'next' === y.swipeDirection
                            ? y.snapGrid[m]
                            : y.snapGrid[m - 1]),
                          y.rtl || (u = -u);
                    ...
                    return void (
                      (!y.params.freeModeMomentum || i >= y.params.longSwipesMs) &&
                  ...
                  for (v = 0; v < y.slidesGrid.length; v += y.params.slidesPerGroup)
                    'undefined' != typeof y.slidesGrid[v + y.params.slidesPerGroup]
                      ? r >= y.slidesGrid[v] &&
                        ...
                        ((_ = v), (w = y.slidesGrid[v + y.params.slidesPerGroup] - y.slidesGrid[v]))
                      : r >= y.slidesGrid[v] &&
                        ((_ = v),
                        (w =
                  ...
                  if (i > y.params.longSwipesMs) {
                    ...
                    'next' === y.swipeDirection && y.slideTo(_ + y.params.slidesPerGroup),
              ...
              (y.setWrapperTranslate = function (e, t, n) {
                ...
                s() ? (i = y.rtl ? -e : e) : (r = e),
                  ...
                  y.params.virtualTranslate ||
                    (y.support.transforms3d
                      ? y.wrapper.transform('translate3d(' + i + 'px, ' + r + 'px, ' + a + 'px)')
                      : y.wrapper.transform('translate(' + i + 'px, ' + r + 'px)')),
                  (y.translate = s() ? i : r);
                var o,
                ...
                (o = 0 === c ? 0 : (e - y.minTranslate()) / c),
                  ...
                  y.params.control && y.controller && y.controller.setTranslate(y.translate, n),
              ...
              (y.getWrapperTranslate = function (e) {
                return (
                  'undefined' == typeof e && (e = s() ? 'x' : 'y'), y.getTranslate(y.wrapper[0], e)
                );
              }),
              (y.observers = []),
              ...
              (y.updateLoop = function () {
                ...
                if (angular.element(e).hasClass(y.params.slideDuplicateClass)) {
                  for (
                    ...
                    if (
                      !angular.element(n[i]).hasClass(y.params.slideDuplicateClass) &&
                      angular.element(n[i]).attr('data-swiper-slide-index') === t
                    ) {
                      y.slideTo(i, 0, !1, !0);
                      break;
                    }
              ...
              (y.createLoop = function () {
                y.wrapper
                  .children('.' + y.params.slideClass + '.' + y.params.slideDuplicateClass)
                  .remove();
                ...
                for (
                  e.each(function (n, i) {
                    ...
                    n < y.loopedSlides && s.push(i),
                      n < e.length && n >= e.length - y.loopedSlides && a.push(i),
                  ...
                  (r = angular.element(s[n]).clone().addClass(y.params.slideDuplicateClass)),
                ...
                for (n = a.length - 1; n >= 0; n--)
                  (r = angular.element(a[n]).clone().addClass(y.params.slideDuplicateClass)),
                    r.removeAttr('ng-transclude'),
                    r.removeAttr('ng-repeat'),
              ...
              (y.fixLoop = function () {
                ...
                y.activeIndex < y.loopedSlides
                  ...
                  : (('auto' === y.params.slidesPerView && y.activeIndex >= 2 * y.loopedSlides) ||
                      y.activeIndex > y.slides.length - 2 * y.params.slidesPerView) &&
              ...
              (y.removeSlide = function (e) {
                y.params.loop &&
                  (y.destroyLoop(), (y.slides = y.wrapper.children('.' + y.params.slideClass)));
                var t,
                  n = y.activeIndex;
                if ('object' == typeof e && e.length) {
                ...
                y.params.loop && y.createLoop(),
                  (y.params.observer && y.support.observer) || y.update(!0),
                  y.params.loop ? y.slideTo(n + y.loopedSlides, 0, !1) : y.slideTo(n, 0, !1);
              }),
                  ...
                  setTranslate: function () {
                    ...
                    for (var i = 0; i < y.slides.length; i++) {
                      ...
                      i % 4 === 0
                        ...
                        : (i - 3) % 4 === 0 && ((c = -y.size), (u = 3 * y.size + 4 * y.size * o)),
                        y.rtl && (c = -c),
                        s() || ((d = c), (c = 0));
                      var p =
                        'rotateX(' +
                  ...
                  setTranslate: function () {
                    for (
                      var e = y.translate,
                        ...
                        i = s() ? y.params.coverflow.rotate : -y.params.coverflow.rotate,
                          ...
                          y.loadImage(e[0], a || r, o, !1, function () {
                            if (
                              (r
                                ...
                                : (o && (e.attr('srcset', o), e.removeAttr('data-srcset')),
                                  a && (e.attr('src', a), e.removeAttr('data-src'))),
                  ...
                  if (y.params.lazyLoadingInPrevNext)
                    if (y.params.slidesPerView > 1) {
                      for (
                        ...
                        e < y.activeIndex + y.params.slidesPerView + y.params.slidesPerView;
                        e++
                      )
                        y.slides[e] && y.lazy.loadImageInSlide(e);
                ...
                onTransitionStart: function () {
                  y.params.lazyLoading &&
                    (y.params.lazyLoadingOnTransitionStart ||
                      (!y.params.lazyLoadingOnTransitionStart && !y.lazy.initialImageLoaded)) &&
                    y.lazy.load();
                },
                ...
                set: function () {
                  if (y.params.scrollbar) {
                    ...
                    (e.track = t(y.params.scrollbar)),
                      ...
                      0 === e.drag.length &&
                        ((e.drag = t('<div class="swiper-scrollbar-drag"></div>')),
                ...
                LinearSpline: function (e, t) {
                  ...
                  this.interpolate = function (e) {
                    return e
                      ? ((i = r(this.x, e)),
                        (n = i - 1),
                        ((e - this.x[n]) * (this.y[i] - this.y[n])) / (this.x[i] - this.x[n]) +
                          this.y[n])
                      : 0;
                  };
                  var r = (function () {
                    ...
                    t.setWrapperTransition(e, y),
                      0 !== e &&
                        ...
                        t.wrapper.transitionEnd(function () {
                          a &&
                            (t.params.loop && 'slide' === y.params.controlBy && t.fixLoop(),
                            t.onTransitionEnd());
                        }));
                  }
                  var r,
              ...
              (y.hashnav = {
                ...
                setHash: function () {
                  y.hashnav.initialized &&
                    y.params.hashnav &&
                    (document.location.hash = y.slides.eq(y.activeIndex).attr('data-hash') || '');
                },
              }),
            ...
            return (
              ...
              (y.emit = function (e) {
                y.params[e] &&
                  y.params[e](arguments[1], arguments[2], arguments[3], arguments[4], arguments[5]);
                var t;
                  ...
                  y.params.pagination &&
                    ...
                    y.bullets.each(function () {
                      ...
                      y.a11y.makeFocusable(e),
                        ...
                        y.a11y.addLabel(
                          e,
                          y.params.paginationBulletMessage.replace(/{{index}}/, e.index() + 1),
                        );
                    });
                },
                destroy: function () {
                  ...
                  y.params.loop
                    ...
                    : (y.slideTo(y.params.initialSlide, 0, y.params.runCallbacksOnInit),
                      0 === y.params.initialSlide &&
                        (y.parallax && y.params.parallax && y.parallax.setTranslate(),
                        y.lazy &&
                          y.params.lazyLoading &&
              ...
              (y.cleanupStyles = function () {
                y.container.removeClass(y.classNames.join(' ')).removeAttr('style'),
                  ...
                  y.paginationContainer &&
                    ...
                    y.paginationContainer.removeClass(y.params.paginationHiddenClass),
                  y.bullets &&
                    y.bullets.length &&
                    y.bullets.removeClass(y.params.bulletActiveClass),
                  y.params.prevButton &&
            ...
            return (
              (e.prototype = {
                ...
                on: function (e, n, i, r) {
                  ...
                  for (o = 0; o < this.length; o++)
                    if ('function' == typeof n || n === !1)
                      for (
                        'function' == typeof n && ((i = arguments[1]), (r = arguments[2] || !1)),
                          s = 0;
                        s < l.length;
                        s++
                      )
                      ...
                      for (s = 0; s < l.length; s++)
                        this[o].dom7LiveListeners || (this[o].dom7LiveListeners = []),
                          this[o].dom7LiveListeners.push({ listener: i, liveListener: a }),
                  ...
                  for (var r = e.split(' '), a = 0; a < r.length; a++)
                    for (var o = 0; o < this.length; o++)
                      if ('function' == typeof t || t === !1)
                        'function' == typeof t && ((n = arguments[1]), (i = arguments[2] || !1)),
                ...
                once: function (e, t, n, i) {
                  ...
                  var a = this;
                  'function' == typeof t && ((t = !1), (n = arguments[1]), (i = arguments[2])),
                    a.on(e, t, r, i);
                },
      ...
      var o;
      (o = 'undefined' == typeof i ? window.Dom7 || window.Zepto || window.jQuery : i),
        o &&
...
(function (T, P, u) {
  ...
  function ia(a, b) {
    if (M(a)) {
      ...
      for (d in ((b = b || {}), a)) if ('$' !== d.charAt(0) || '$' !== d.charAt(1)) b[d] = a[d];
    return b || a;
  }
  function na(a, b) {
    if (a === b) return !0;
  ...
  function yb(a, b) {
    var d = a.ng339,
      d = d && hb[d];
    b && !d && ((a.ng339 = d = ++Mf), (d = hb[d] = { events: {}, data: {}, handle: u }));
    return d;
  }
  function Xb(a, b, d) {
    if (Kc(a)) {
      ...
      if (b) {
        ...
        if (!c.history || (h && f)) {
          ...
          d
            ? l.replace(b)
            : h
            ? ((d = l), (e = b.indexOf('#')), (e = -1 === e ? '' : b.substr(e)), (d.hash = e))
            : (l.href = b);
          l.href !== b && (t = b);
  ...
  function cf() {
    this.$get = function () {
      function a(a, c) {
        function e(a) {
          a != n &&
            (p ? p == a && (p = a.n) : (p = a), f(a.n, a.p), f(a, n), (n = a), (n.n = null));
        }
        function f(a, b) {
          a != b && (a && (a.p = b), b && (b.n = a));
        }
    ...
    this.$get = [
      ...
      function (a, b, c, m, v, Q, t, G, C, K) {
        ...
        function xa(a, b, c, d, e, f) {
          function g(a, c, d, e) {
            var f, k, l, m, n, p, G;
            if (r) for (G = Array(c.length), m = 0; m < h.length; m += 3) (f = h[m]), (G[f] = c[f]);
            else G = c;
            m = 0;
            for (n = h.length; m < n; )
              (k = G[h[m++]]),
                ...
                (f = h[m++]),
                c
                  ? (c.scope ? ((l = a.$new()), ba.$$addScopeInfo(H(k), l)) : (l = a),
        ...
        function ra(a, b, d, e, f, g, h, k, l) {
          ...
          function n(a, c, e, f, g) {
            ...
            v && (K = T(t, f, x, v, B, c, C));
            C &&
              (ba.$$addScopeInfo(t, B, !0, !(w && (w === C || w === C.$$originalDirective))),
          ...
          for (
            ...
            if (
              !Ea &&
              ((B.replace && (B.templateUrl || B.template)) || (B.transclude && !B.$$tlb))
            ) {
              for (y = ra + 1; (Ea = a[y++]); )
                if (
            ...
            if ((y = B.transclude))
              if (((K = !0), B.$$tlb || (X('transclusion', I, B, t), (I = B)), 'element' == y))
                (Ca = !0),
                  ...
                  (s = Zb(E, Q, e, p, g && g.name, { nonTlbTranscludeDirective: I }));
              else {
                var P = V();
                Q = H(Wb(b)).contents();
                if (J(y)) {
        ...
        function jb(a, b, c, d) {
          ...
          } else if (M(b)) for (e = [], g = 0, f = b.length; g < f; g++) e[g] = jb(a, b[g], c, d);
          else
            J(b) &&
              ((e = {}),
              q(b, function (b, f) {
                  ...
                  if (!n.$$bindings) {
                    ...
                    J(C.scope) &&
                      (!0 === C.bindToController
                        ? ((B.bindToController = d(C.scope, w, !0)), (B.isolateScope = {}))
        ...
        function U(a, b) {
          ...
          q(b, function (b, f) {
            'class' == f
              ? (B(e, b), (a['class'] = (a['class'] ? a['class'] + ' ' : '') + b))
              : 'style' == f
        ...
        function aa(a, b, c, d, e, f, g, h) {
          ...
          return function (a, b, c, d, e) {
            ...
            b.$$destroyed ||
              (k
                ? k.push(b, c, d, a)
                : (l.transcludeOnThisElement && (a = s(b, l.transclude, e)), l(n, b, c, d, a)));
          };
        }
        function Z(a, b) {
      ...
      function (d, c, e) {
        ...
        function k(f, k, n, r) {
          ...
          if (!f.length || -1 === f.indexOf(a)) {
            var v;
            k ||
              ((k = g(f)), (v = da(k)), (v.exp = f), (v.expressions = []), (v.$$watchDelegate = h));
            return v;
          }
          r = !!r;
          var q,
        ...
        c.onUrlChange(function (a, b) {
          z(la(F, a))
            ...
            : (d.$evalAsync(function () {
                ...
                l.absUrl() === a &&
                  (f ? (l.$$parse(c), (l.$$state = e), h(c, !1, e)) : ((x = !1), k(c, e)));
              }),
              d.$$phase || d.$digest());
        });
        d.$watch(function () {
      ...
      function (c) {
        ...
        function n(a, b) {
          ...
          a.$$watchDelegate && a.$$watchDelegate !== h
            ...
            : b.$stateful ||
              ((c.$$watchDelegate = h), (d = !a.inputs), (c.inputs = a.inputs ? a.inputs : [a]));
          return c;
        }
  ...
  function xf() {
    this.$get = [
      ...
      function (a, b) {
        var d = {},
          c =
            !(a.chrome && a.chrome.app && a.chrome.app.runtime) && a.history && a.history.pushState,
          ...
          findBindings: function (a, b, d) {
            ...
            q(a, function (a) {
              ...
              c &&
                q(c, function (c) {
                  d
                    ? new RegExp('(^|\\s)' + ud(b) + '(\\s|\\||$)').test(c) && g.push(a)
    ...
    return function () {
      ...
      if (a !== e)
        for (e = a, a = e.split('; '), c = {}, h = 0; h < a.length; h++)
          (g = a[h]),
            (k = g.indexOf('=')),
            0 < k && ((l = b(g.substring(0, k))), z(c[l]) && (c[l] = b(g.substring(k + 1))));
      return c;
    };
  }
  function Gf() {
  ...
  function yd(a) {
    ...
    return function (a, c, e) {
      ...
      return null == a
        ? a
        : Cd(a, b.PATTERNS[1], b.GROUP_SEP, b.DECIMAL_SEP, e).replace(/\u00A4/g, c);
    };
  }
  function Ad(a) {
    var b = a.NUMBER_FORMATS;
  ...
  function tg(a, b, d, c) {
    ...
    if (0 < d) {
      ...
      for (
        f = Math.max(0, f), a.i = 1, e.length = Math.max(1, (d = b + 1)), e[0] = 0, g = 1;
        g < d;
        g++
      )
        e[g] = 0;
  ...
  function Id(a) {
    ...
    c.$setValidity = function (a, e, f) {
      z(e)
        ...
        : (c.$pending && h(c.$pending, a, f), Nd(c.$pending) && (c.$pending = u));
      Oa(e)
        ? e
      ...
      c.$pending
        ...
        : (b(Od, !1), (c.$valid = Nd(c.$error)), (c.$invalid = !c.$valid), d('', c.$valid));
  ...
  var M = Array.isArray,
    ...
    Ac = !1,
    Pa = 3,
    ke = { full: '1.5.3', major: 1, minor: 5, dot: 3, codeName: 'diplohaplontic-meiosis' };
  U.expando = 'ng339';
  var hb = (U.cache = {}),
    Mf = 1;
  U._data = function (a) {
  ...
  s.prototype = {
    ...
    ternary: function () {
      ...
      return this.expect('?') && ((b = this.expression()), this.consume(':'))
        ? ((d = this.expression()),
          { type: s.ConditionalExpression, test: a, alternate: b, consequent: d })
        : a;
    },
    logicalOR: function () {
    ...
    primary: function () {
      ...
      for (var b; (b = this.expect('(', '[', '.')); )
        '(' === b.text
          ? ((a = { type: s.CallExpression, callee: a, arguments: this.parseArguments() }),
            this.consume(')'))
          : '[' === b.text
          ? ((a = {
    ...
    filter: function (a) {
      a = [a];
      for (
        var b = { type: s.CallExpression, callee: this.identifier(), arguments: a, filter: !0 };
        this.expect(':');
          ...
          case s.ObjectExpression:
            ...
            q(a.properties, function (a) {
              k.recurse(a.value, k.nextId(), u, function (b) {
                l.push(
                  k.escape(a.key.type === s.Identifier ? a.key.name : '' + a.key.value) + ':' + b,
                );
              });
            });
            m = '{' + l.join(',') + '}';
      ...
      switch (a.type) {
        ...
        case s.MemberExpression:
          return (
            ...
            a.computed || (Wa(a.property.name, f.expression), (e = a.property.name)),
  ...
  var wg = {
      ...
      Z: function (a, b, d) {
        ...
        return (a =
          (0 <= a ? '+' : '') +
          (Jb(Math[0 < a ? 'floor' : 'ceil'](a / 60), 2) + Jb(Math.abs(a % 60), 2)));
      },
      ww: Gd(2),
      w: Gd(1),
      G: kc,
        ...
        if (!b.href && !b.xlinkHref)
          return function (a, b) {
            if ('a' === b[0].nodeName.toLowerCase()) {
              var e =
                '[object SVGAnimatedString]' === ka.call(b.prop('href')) ? 'xlink:href' : 'href';
                ...
                pre: function (a, d, e, f) {
                  ...
                  g &&
                    ...
                    e.$observe(g, function (b) {
                      n.$name !== b &&
                        (q(a, u), n.$$parentForm.$$renameControl(n, b), (q = c(n.$name)), q(a, n));
                    }));
                  d.on('$destroy', function () {
        ...
        this.$validate = function () {
          if (!R(r.$modelValue) || !isNaN(r.$modelValue)) {
            ...
            r.$$runValidators(a, r.$$lastCommittedViewValue, function (e) {
              d ||
                b === e ||
                ((r.$modelValue = e ? a : u), r.$modelValue !== c && r.$$writeModelToScope());
            });
          }
        };
          ...
          link: {
            ...
            post: function (b, g, h, k) {
              ...
              function m(a, b, c, d) {
                b && N(b.nodeName) === c
                  ? (c = b)
                  : ((c = d.cloneNode(!1)), b ? a.insertBefore(c, b) : a.appendChild(c));
                return c;
              }
              function n(a) {
                  ...
                  A(a.group)
                    ? ((f = b[a.group]),
                      f ||
                        ...
                        (d = f.nextSibling),
                        (f.label = a.group),
                        (f = b[a.group] = { groupElement: f, currentOptionElement: f.firstChild })),
                      (h = m(f.groupElement, f.currentOptionElement, 'option', c)),
                      l(a, h),
                      (f.currentOptionElement = h.nextSibling))
                    : ((h = m(g[0], d, 'option', c)), l(a, h), (d = h.nextSibling));
                });
              ...
              r
                ...
                : ((u.writeValue = function (a) {
                  ...
                  (u.readValue = function () {
                    ...
                    return a && !a.disabled
                      ? (t || w.remove(), G.remove(), C.getViewValueFromOption(a))
                      : null;
                  }),
                  z.trackBy &&
                    b.$watch(
          ...
          function (b, c, f, u, l, w, s, M, v, h) {
            ...
            function k(a, g, k) {
              ...
              function G(b) {
                ...
                g.preparationClasses &&
                  (c.removeClass(g.preparationClasses), (g.preparationClasses = null));
              ...
              if (Z) {
                ...
                if (d('cancel', a, l, k))
                  ...
                  if (2 === k.state) T(a, l, {});
                    ...
                    return (
                      Qa(a, v ? g : null, h), (g = l.event = k.event), (h = T(a, k, l)), k.runner
                    );
              } else T(a, l, {});
              (Z = l.structural) ||
                (Z = ('animate' === l.event && 0 < Object.keys(l.options.to || {}).length) || e(l));
            ...
            function n(a, b, c) {
              ...
              for (b = A(b); b; ) {
                ...
                if (N(h) || !0 === h) (a = H.data(b, '$$ngAnimateChildren')), Y(a) && (h = a);
                if (k && !1 === h) break;
                g || (g = J(b, c));
                if (g && d) break;
              ...
              function P(a) {
                ...
                q(c, function (c, h) {
                  ...
                  if (e && f) {
                    ...
                    (e = e ? e.animationID : f.animationID),
                      (f = e.toString()),
                      d[f] || ((d[f] = !0), b.push(a[e]));
                });
                return b;
              }
              function y(a, b) {
        ...
        this.$get = [
          ...
          function (a, e, f, r, x, F, u, l) {
            ...
            function v(c, h, e) {
              ...
              h ||
                ((h = Da(a, c, Sa)),
                'infinite' === h.animationIterationCount && (h.animationIterationCount = 1));
              b.put(e, h);
              c = h;
              e = c.animationDelay;
              h = c.transitionDelay;
            ...
            return function (a, c) {
                ...
                function b() {
                  if (!P) {
                    ...
                    p.applyAnimationDelay &&
                      (($ = 'boolean' !== typeof g.delay && sa(g.delay) ? parseFloat(g.delay) : $),
                      (I = Math.max($, 0)),
                      (B.animationDelay = $),
                      (aa = [qa, $ + 's']),
                      y.push(aa),
                    ...
                    if (g.easing) {
                      var d,
                        f = g.easing;
                      p.hasTransitions &&
                        ((d = R + 'TimingFunction'), y.push([d, f]), (m.style[d] = f));
                      p.hasAnimations &&
                        ((d = X + 'TimingFunction'), y.push([d, f]), (m.style[d] = f));
                    }
              ...
              g.removeClass && (S.length && (S += ' '), (S += V(g.removeClass, '-remove')));
              ...
              0 <= g.duration &&
                ((t = 0 < m.style[R].length), (t = Ea(g.duration, t)), la(m, t), y.push(t));
              ...
              if (p.applyTransitionDuration || p.applyAnimationDuration)
                (L = g.duration ? parseFloat(g.duration) : L),
                  ...
                  p.applyAnimationDuration &&
                    ((p.hasAnimations = !0), (B.animationDuration = L), y.push([wa, L + 's']));
              ...
              g.skipBlocking ||
                ...
                (p.blockKeyframeAnimation =
                  0 < B.animationDuration && 0 < U.animationDelay && 0 === U.animationDuration));
            ...
            return function (a, b, d, u) {
              ...
              if (y.length) {
                ...
                'leave' == b
                  ...
                  : ((J = 'before' + b.charAt(0).toUpperCase() + b.substr(1)), (I = b));
...
(function (A, e, B) {
  ...
  function D(a, c) {
    ...
    for (b = g.firstChild; b; ) {
      ...
      if (
        !(d = b.firstChild) &&
        (1 == b.nodeType && c.end(b.nodeName.toLowerCase()), (d = b.nextSibling), !d)
      )
        for (; null == d; ) {
          b = b.parentNode;
          if (b === g) break;
        ...
        return (
          ...
          function (d, f, g) {
            ...
            f.$$inheritedValues && e(t, l(f.$$inheritedValues, p)),
              M(s, f.$$promises),
              f.$$values
                ? ((v = e(t, l(f.$$values, p))), (r.$$inheritedValues = l(f.$$values, p)), h())
                : (f.$$inheritedValues && (r.$$inheritedValues = l(f.$$inheritedValues, p)),
                  f.then(h, i));
      ...
      (this.fromConfig = function (a, b, c) {
        ...
        (this.fromUrl = function (c, d) {
          return (
            ...
            null == c
              ? null
              : a.get(c, { cache: b, headers: { Accept: 'text/html' } }).then(function (a) {
                  return a.data;
                })
          );
        }),
    ...
    function q(a, b, e) {
      ...
      function h(c, e) {
        ...
        return (
          ...
          (i = O.type(g || 'string') || d(O.type('string'), { pattern: new RegExp(g) })),
    ...
    function s() {
      ...
      (s.$$getDefaultValue = function (a) {
        ...
        (this.defaultSquashPolicy = function (a) {
          ...
          if (a !== !0 && a !== !1 && !I(a))
            throw new Error(
              'Invalid squash policy: ' + a + '. Valid policies: false, true, arbitrary-string',
            );
          return (u = a), a;
        }),
        ...
        (this.type = function (a, b, c) {
          ...
          return (
            (v[a] = new r(M({ name: a }, b))), c && (x.push({ name: a, def: c }), w || k()), this
          );
        }),
        L(y, function (a, b) {
    ...
    function u(a, e) {
      ...
      function r(a) {
        ...
        if (
          ...
          '**' === b[b.length - 1] &&
            (c.splice(h(c, b[b.length - 2]) + 1, Number.MAX_VALUE), c.push('**')),
          b.length != c.length)
        )
          return !1;
      ...
      function s(a, b) {
        return I(a) && !G(b)
          ? B[a]
          : H(b) && I(a)
          ? (B[a] && !B.$delegates[a] && (B.$delegates[a] = B[a]), (B[a] = b), this)
          : this;
      }
      function t(a, b) {
      ...
      function u(a, e, f, h, m, o, p) {
            ...
            h.then(
              function () {
                return h !== x.transition
                  ? u
                  : ((b.options.$retry = !0), x.transitionTo(b.to, b.toParams, b.options));
              },
              function () {
                return B;
              },
        ...
        return (
          ...
          (x.transitionTo = function (b, c, f) {
            (c = c || {}),
              (f = M(
                { location: !0, inherit: !1, relative: null, notify: !0, reload: !1, $retry: !1 },
                f || {},
              ));
            var g,
              j = x.$current,
            ...
            if (v(b, j, F, f))
              return (
                b.self.reloadOnSearch !== !1 && p.update(), (x.transition = null), e.when(x.current)
              );
            if (
              ((c = k(b.params.$$keys(), c || {})),
              ...
              function () {
                ...
                return x.transition !== K
                  ...
                  : ((x.$current = b),
                    ...
                    f.location &&
                      b.navigable &&
                      p.push(b.navigable.url, b.navigable.locals.globals.$stateParams, {
                        $$avoidResync: !0,
          ...
          (x.href = function (a, b, d) {
            ...
            return f && f.url !== c && null !== f.url
              ? p.href(f.url, k(e.params.$$keys(), b || {}), { absolute: d.absolute })
              : null;
          }),
          (x.get = function (a, b) {
      ...
      function v(a, b, c, d) {
        return a !== b || ((c !== b.locals || d.reload) && a.self.reloadOnSearch !== !1)
          ? void 0
          : !0;
      }
      var w,
        ...
        B = {
          ...
          data: function (a) {
            return (
              a.parent && a.parent.data && (a.data = a.self.data = M({}, a.parent.data, a.data)),
              a.data
            );
          },
          url: function (a) {
        ...
        link: function (e, f, g, h) {
          ...
          var s = function (c) {
            if ((c && (j = b.copy(c)), p)) {
              ...
              var d = h[1] || h[0];
              return (
                d && d.$$setStateInfo(i.state, j), null === l ? ((p = !1), !1) : void g.$set(o, l)
              );
            }
          };
          i.paramExpr &&
...
!(function () {
  function e(e, t, n, i, o, r) {
    function a(i, a, c, s, u) {
      ...
      if ((y.parentNode.replaceChild(S, y), b.options.scrollingX && b.options.scrollingY))
        throw new Error(
      ...
      r(g, 0, !1),
        i.$watchCollection(x, function (e) {
          if (((P = e || (e = [])), !angular.isArray(e)))
            throw new Error(
              "collection-repeat expected an array for '" + B + "', but got a " + typeof value,
            );
    ...
    return function (o) {
      ...
      function a(t) {
        if (!a.destroyed) {
          ...
          for (n = F; W >= n; n++)
            n >= A.length ||
              (Z[n] && !t) ||
              ((r = Z[n] || (Z[n] = G.length ? G.pop() : j.length ? j.shift() : new s())),
              K.push(r),
              (r.isShown = !0),
              (u = r.scope),
              (u.$index = n),
              ...
              (r.secondaryPos !== l.secondaryPos || r.primaryPos !== l.primaryPos) &&
                (r.node.style[ionic.CSS.TRANSFORM] = O.replace(
                  N,
                  (r.primaryPos = l.primaryPos),
                ).replace(z, (r.secondaryPos = l.secondaryPos))),
              (r.secondarySize !== l.secondarySize || r.primarySize !== l.primarySize) &&
          ...
          for (
            ...
            (w.style[ionic.CSS.TRANSFORM] = O.replace(N, l.primaryPos + l.primarySize).replace(
              z,
              0,
            )));
            G.length;
          ...
          if (t) for (var b = e.$$phase; K.length; ) (r = K.pop()), b || r.scope.$digest();
          else c();
        }
      }
      function c() {
        ...
        (this.getItemPrimarySize = P),
          ...
          (this.refreshDirection = function () {
            (this.scrollPrimarySize = B.__clientHeight),
              ...
              (this.estimatedItemsAcross = (R && Math.floor(B.__clientWidth / $)) || 1);
          });
      }
      function u() {
        (this.getItemPrimarySize = D),
          ...
          (this.refreshDirection = function () {
            (this.scrollPrimarySize = B.__clientWidth),
              ...
              (this.estimatedItemsAcross = (R && Math.floor(B.__clientHeight / v)) || 1);
          });
      }
      function d() {
      ...
      function p() {
            ...
            (r = c[t - 1] || i),
              ...
              0 === t || a.secondaryPos + a.secondarySize > o.scrollSecondarySize
                ...
                : ((a.primarySize = o.getItemPrimarySize(t, A[t])),
                  ...
                  (c[a.rowStartIndex].rowPrimarySize = a.rowPrimarySize =
        ...
        this.updateRenderRange = function (e, t) {
          ...
          if ((this.getDimensions(2 * this.getEstimatedIndex(t)), -1 === s || 0 === e)) n = 0;
            ...
            for (
              n = s, i = A.length;
              i > n && !((o = this.getDimensions(n)) && o.primaryPos + o.rowPrimarySize >= e);
              n++
            );
          else
            for (n = s; n >= 0; n--)
          ...
          for (n = F + 1, i = A.length; i > n; n++)
            if ((o = this.getDimensions(n)) && o.primaryPos + o.rowPrimarySize > t) {
              if (R)
                for (
                  r = o;
                  i - 1 > n && (o = this.getDimensions(n + 1)).primaryPos === r.primaryPos;
          ...
          (W = Math.min(n, A.length - 1)),
            (X =
              -1 !== W
                ? (o = this.getDimensions(W)).primaryPos + (o.rowPrimarySize || o.primarySize)
                : -1),
            (l = e),
            (s = F);
        };
      ...
      (this.refreshLayout = function () {
        ...
        (ie = !0),
          ie &&
            oe &&
            ((B.__scrollLeft > B.__maxScrollLeft || B.__scrollTop > B.__maxScrollTop) && B.resize(),
            r(!0));
      }),
            ...
            }),
            {
                ...
                if ((b !== l && ((b = l), L++), C))
                    ...
                    M.historyId === $.historyId
                      ...
                      : $ &&
                        ...
                        i && i.parentHistoryId === $.historyId
                          ? (H = E)
                          : ((i = f($.historyId)),
                            i && i.parentHistoryId === d.parentHistoryId && (H = _)));
                  ...
                  if (
                    ...
                    i && i.parentHistoryId === q
                      ? (H = P)
                      : ((i = f(q)), i && i.parentHistoryId === $.historyId && (H = E)),
                    (i = s(F.backViewId)),
                    ...
                    W.forEach(function (e) {
                      var t = R.views[e];
                      t.backViewId === F.viewId &&
                        t.historyId !== F.historyId &&
                        (t.backViewId = null);
                    }),
                ...
                if ((S && S(), o.cancel(k), y)) {
                  if (
                    ...
                    for (a = 0; a < d.stack.length; a++)
                      d.stack[a].viewId === z
                        ? ((d.stack[a].index = 0),
                          (d.stack[a].backViewId = d.stack[a].forwardViewId = null))
              ...
              currentTitle: function (e) {
                return R.currentView
                  ? (arguments.length && (R.currentView.title = e), R.currentView.title)
                  : void 0;
              },
              backView: function (e) {
              ...
              goBack: function (e) {
                if (l(e) && -1 !== e) {
                  ...
                  for (
                    ...
                    a && (r.push(a.stateId || a.viewId), i++, !(i >= t.stack.length));
                ...
                if (e)
                  for (var n in e)
                    e[n].stack && ((e[n].stack = []), (e[n].cursor = -1)),
                      t && t.historyId === n
                        ? ((t.backViewId = t.forwardViewId = null), e[n].stack.push(t))
          ...
          (o.transitions.views.ios = function (e, t, n, i) {
            function o(e, t, n, i) {
              ...
              (o[ionic.CSS.TRANSITION_DURATION] = r.shouldAnimate ? '' : 0),
                (o.opacity = t),
                i > -1 &&
                  (o.boxShadow = '0 0 10px rgba(0,0,0,' + (r.shouldAnimate ? 0.45 * i : 0.3) + ')'),
            ...
            var r = {
              run: function (i) {
                'forward' == n
                  ? (o(e, 1, 99 * (1 - i), 1 - i), o(t, 1 - 0.1 * i, -33 * i, -1))
                  : 'back' == n
                  ? (o(e, 1 - 0.1 * (1 - i), -33 * (1 - i), -1), o(t, 1, 100 * i, 1 - i))
                  : (o(e, 1, 0, -1), o(t, 0, 0, -1));
              },
    ...
    .factory('$ionicLoading', [
      ...
      function (e, t, n, i, o, r, a, s, l, u, d) {
        function f() {
          return (
            m ||
              (m = n.compile({ template: p, appendTo: t.get() }).then(function (e) {
                return (
                  (e.show = function (a) {
                    var c = a.templateUrl
                    ...
                    (e.scope = a.scope || e.scope),
                      e.isShown ||
                        ((e.hasBackdrop = !a.noBackdrop && a.showBackdrop !== !1),
                        e.hasBackdrop && (i.retain(), i.getElement().addClass('backdrop-loading'))),
                      a.duration &&
                        (o.cancel(e.durationTimeout),
                        (e.durationTimeout = o(angular.bind(e, e.hide), +a.duration))),
                      $(),
                      ...
                      c.then(function (n) {
                        ...
                        e.isShown &&
                          ...
                          ionic.requestAnimationFrame(function () {
                            e.isShown &&
                              (e.element.addClass('active'), t.addClass('loading-active'));
                          }));
                      }),
                      (e.isShown = !0);
                  }),
                  (e.hide = function () {
                    $(),
                      e.isShown &&
                        (e.hasBackdrop &&
                          (i.release(), i.getElement().removeClass('backdrop-loading')),
        ...
        function v(t) {
          ...
          return (
            ...
            b(),
            t.hideOnStateChange &&
              ((w = u.$on('$stateChangeSuccess', g)), (b = u.$on('$stateChangeError', g))),
            o.cancel(y),
            (y = o(h, n)),
        ...
        var p = ionic.views.Modal.inherit({
            ...
            remove: function () {
              var e,
                ...
                n = this;
              return (
                n.scope.$parent && n.scope.$parent.$broadcast(n.viewType + '.removed', n),
                n._isShown ? (t = n.hide()) : ((e = a.defer()), e.resolve(), (t = e.promise)),
                t.then(function () {
      ...
      function (e, t, n, i) {
        function o(e, n) {
          ...
          d.left < r ? (d.left = r) : d.left + c + r > l && (d.left = l - c - r),
            ...
            h.css({ left: a.left + a.width / 2 - h.prop('offsetWidth') / 2 - d.left + 'px' }),
            n.css({ top: d.top + 'px', left: d.left + 'px', marginLeft: '0', opacity: '1' });
        }
        var r = 6,
  ...
  a.factory('$ionicPopup', [
    ...
    function (e, t, n, i, o, r, a, s, l, u) {
      function d(t) {
        ...
        return (
          ...
          n
            .when(t.templateUrl ? e.load(t.templateUrl) : t.template || t.content || '')
            .then(function (e) {
        ...
        return (
          S.length > 0
            ...
            : (r.addClass('popup-open'),
              t.retain(),
              (k._backButtonActionDone = s.registerBackButtonAction(p, u.popup))),
    ...
    a.service('$ionicTabsDelegate', ionic.DelegateService(['select', 'selectedIndex', 'showBar'])),
    (function () {
      var e = [];
      a.factory('$ionicTemplateCache', [
        '$http',
        '$templateCache',
        '$timeout',
        function (t, n, i) {
              ...
              if ('object' == typeof r) {
                ...
                if ((a && d(r.templateUrl) && e.push(r.templateUrl), angular.isObject(r.views)))
                  for (var c in r.views)
                    (a =
                      r.views[c].prefetchTemplate !== !1 && e.length < n.templates.maxPrefetch()),
                      a && d(r.views[c].templateUrl) && e.push(r.views[c].templateUrl);
              }
              return i.call(t, o, r);
            };
          },
                ...
                q = {
                  ...
                  loadViewElements: function (e) {
                    ...
                    for (
                      ...
                      o.data(C) === c
                        ? o.data(S)
                          ? (o.data(C, c + ionic.Utils.nextUid()), o.data(k, !0))
                          : (N = o)
                        : l(u) && o.data(C) === u && (z = o),
                      !N || !z);
                      n++
                  ...
                  transition: function (a, l, u) {
                    ...
                    function m() {
                      m.x ||
                        ...
                        C && C.resolve(t),
                        H === P &&
                          (n.all(L).then(M.transitionEnd), q.emit('after', T, B), q.cleanup(T)),
                        r._instances.forEach(function (e) {
                    ...
                    if (
                      (F.shouldAnimate && (N.on(y, g), N.data(I, e(m, R)), i.show(R)),
                      ...
                      if (!_)
                        return (
                          ...
                          p(z, 'leaving'),
                          {
                            run: F.run,
                            cancel: function (t) {
                              t ? (N.on(y, S), N.data(I, e(k, R)), i.show(R)) : k(),
                                (F.shouldAnimate = t),
                                F.run(0),
                                (F = null);
                            },
      ...
      function (e, t, n, i, o, r) {
        ...
        (h.beforeEnter = function (t) {
          ...
          (h.updateBackButton = function () {
            var e;
            (b && y && w) !== S &&
              ((S = b && y && w), (e = a(l)), e && e.classList[S ? 'remove' : 'add'](f)),
              w &&
                ((e = e || a(l)),
                e &&
                  ...
                  h.backButtonText !== o.backButton.text() &&
                    ((e = a(l + ' .back-text')),
                    e && (e.textContent = h.backButtonText = o.backButton.text()))));
          }),
                ...
                if (b && p === y) {
                  for (o = 0; o < p.childNodes.length; o++)
                    if (((h = p.childNodes[o]), 1 == h.nodeType))
                      ...
                      3 == h.nodeType &&
                        h.nodeValue.trim() &&
                        ((m = ionic.DomUtil.getTextBounds(h)), (x += (m && m.width) || 0));
                  g = x || p.offsetWidth;
                } else g = p.offsetWidth;
              } else
                3 == p.nodeType &&
                  p.nodeValue.trim() &&
                  ((m = ionic.DomUtil.getTextBounds(p)), (g = (m && m.width) || 0));
              $ ? (C += g) : (k += g);
            }
          ...
          (h.updatePositions = function (e, n, r, c, s, l, p) {
            ...
            if (
              (e &&
                ...
                l !== $ && (l && e.classList.add(l), $ && e.classList.remove($), ($ = l))),
          ...
          if (!s.isLoading) {
            ...
            if (s.jsScrolling) {
              ...
              (e = s.getNativeMaxScroll()),
                ((-1 !== e.left && s.scrollEl.scrollLeft >= e.left - s.scrollEl.clientWidth) ||
                  (-1 !== e.top && s.scrollEl.scrollTop >= e.top - s.scrollEl.clientHeight)) &&
                  o();
          }
        }
        function c(e) {
    ...
    a
      .service(
        '$ionicListDelegate',
        ionic.DelegateService(['showReorder', 'showDelete', 'canSwipeItems', 'closeOptionButtons']),
      )
      ...
      function (e, t, n, i, o, r, a, c) {
        function u(e, t) {
          ...
          n &&
            n.call(
              console,
              'navBarController.' + e + ' is deprecated, please use ' + t + ' instead',
            );
        }
        function d(e) {
        ...
        (I.init = function () {
          ...
          (I.createHeaderBar = function (o) {
            function r(e, t) {
              e &&
                ('title' === t
                  ...
                  ? (v || ((v = f('<div class="buttons buttons-right">')), h.append(v)),
            ...
            var I = {
              ...
              setItem: function (e, t) {
                I.removeItem(t),
                  e
                    ? ('title' === t && I.title(''), r(e, t), m[t] && m[t].addClass(b), ($[t] = e))
              ...
              (I.activeTransition = {
                ...
                cancel: function (t, o, r) {
                  ...
                  r.showBar !== I.showBar() && I.showBar(r.showBar),
                    r.showBackButton !== I.showBackButton() && I.showBackButton(r.showBackButton),
                    a && e.$apply();
                },
          ...
          (I.showBar = function (t) {
            return (
              arguments.length && (I.visibleBar(t), (e.$parent.$hasHeader = !!t)),
              !!e.$parent.$hasHeader
            );
          }),
          ...
          (I.title = function (t, n) {
            return (
              l(t) &&
                ((t = t || ''), (n = n || h()), n && n.title(t), (e.$title = t), c.currentTitle(t)),
              e.$title
            );
          }),
      ...
      function (e, t, n, i, o, r, a, s, l, u, d, f) {
        ...
        (x.scope = e),
          ...
          (x.update = function (e) {
            ...
            n &&
              (n.isPrimary(!1),
              ('enter' === $ || 'exit' === $) && (n.direction($), 'enter' === $ && ($ = 'none')));
          }),
          ...
          (x.clearCache = function (e) {
            ...
            for (o = 0, r = s.length; r > o; o++)
              if (((n = s.eq(o)), e))
                ...
                V(n) == B
                  ? l.destroyViewEle(n)
                  : V(n) == I && ((i = n.scope()), i && i.$broadcast('$ionicView.clearCache'));
          }),
          ...
          (x.initSwipeBack = function () {
            ...
            function o(e) {
              if (A && c && C && C.length > 1) {
                for (
                  var t = Date.now(), n = r(e), s = C[C.length - 1], l = C.length - 2;
                  l >= 0 && !(t - s.t > 200);
                  l--
                )
                  s = C[l];
                ...
                if (((y = v.viewId), (S = 0.03 > f || f > 0.97), u && (f > 0.5 || g > 0.1))) {
                  var m = g > 0.5 || 0.05 > g || n > b - 45 ? 'fast' : 'slow';
                  p(S ? '' : m),
                    v.go(),
                    h && h.activeTransition && h.activeTransition.complete(!S, m);
                } else
                  p(S ? '' : 'fast'),
                    (y = null),
                    c.cancel(!S),
                    h && h.activeTransition && h.activeTransition.cancel(!S, 'fast', I),
                    (S = null);
              }
    ...
    a.controller('$ionicRefresher', [
      ...
      function (e, t, n, i, o) {
        function r(e) {
          (e.touches = e.touches || [{ screenX: e.screenX, screenY: e.screenY }]),
        ...
        function s(e) {
          if (
            ...
            if (
              ...
              return I && ((I = !1), h(!1)), T && f(S, _ - -1 * B), void (0 !== x && d(0));
        ...
        window.navigator.pointerEnabled
          ...
          : window.navigator.msPointerEnabled
          ? ((L = 'MSPointerDown'), (R = 'MSPointerMove'), (M = 'MSPointerUp'))
          : ((L = 'touchstart'), (R = 'touchmove'), (M = 'touchend')),
          (C.init = function () {
            if (
              ((S = n.parent().parent()[0]),
              (k = n.parent()[0]),
              !(S && S.classList.contains('ionic-scroll') && k && k.classList.contains('scroll')))
            )
    ...
    a.controller('$ionicScroll', [
      ...
      function (e, t, n, i, o, r, a, c) {
        ...
        (u = s.isNative()
          ...
          (h.parent().length ? h.parent() : h).data('$$ionicScrollController', s);
        ...
        var g = function (t) {
          ...
          e.$onScroll &&
            e.$onScroll({ event: t, scrollTop: n.scrollTop || 0, scrollLeft: n.scrollLeft || 0 });
        };
        h.on('scroll', g),
          e.$on('$destroy', function () {
            p(),
      ...
      function (e, t, n, i, o, r, a, c, s) {
        ...
        ($.$scope = e),
          ...
          ($.toggleLeft = function (e) {
            if (!m && $.left.isEnabled) {
              ...
              0 === arguments.length && (e = 0 >= t),
                ...
                e
                  ? ($.openPercentage(100), s.$emit('$ionicSideMenuOpen', 'left'))
                  : ($.openPercentage(0), s.$emit('$ionicSideMenuClose', 'left'));
            }
          }),
          ($.toggleRight = function (e) {
            if (!m && $.right.isEnabled) {
              ...
              0 === arguments.length && (e = t >= 0),
                $.content.enableAnimation(),
                e
                  ? ($.openPercentage(-100), s.$emit('$ionicSideMenuOpen', 'right'))
                  : ($.openPercentage(0), s.$emit('$ionicSideMenuClose', 'right'));
            }
          }),
          ($.toggle = function (e) {
          ...
          ($.exposeAside = function (e) {
            (($.left && $.left.isEnabled) || ($.right && $.right.isEnabled)) &&
              ...
              (m = e),
              $.left && $.left.isEnabled && $.right && $.right.isEnabled
                ? $.content.setMarginLeftAndRight(m ? $.left.width : 0, m ? $.right.width : 0)
                : $.left && $.left.isEnabled
                ? $.content.setMarginLeft(m ? $.left.width : 0)
                : $.right && $.right.isEnabled && $.content.setMarginRight(m ? $.right.width : 0),
          ...
          ($._handleDrag = function (t) {
            !m &&
              e.dragContent &&
              (p ? (v = t.gesture.touches[0].pageX) : ((p = t.gesture.touches[0].pageX), (v = p)),
              !f &&
                Math.abs(v - p) > $.dragThresholdX &&
                ((p = v), (f = !0), $.content.disableAnimation(), (g = $.getOpenAmount())),
              f && $.openAmount(g + (v - p)));
          }),
          ...
          ($.isDraggableTarget = function (t) {
            var n = $.edgeThresholdEnabled && !$.isOpen(),
              ...
              o =
                !n || i <= $.edgeThreshold || i >= $.content.element.offsetWidth - $.edgeThreshold,
              a = r.backView(),
              c = w ? !0 : !a;
            if (!c) {
              var s = r.currentView() || {};
        ...
        e.$on('$destroy', function () {
          S(),
            ...
            ($.$scope = null),
            $.content &&
              ($.content.setCanScroll(!0), ($.content.element = null), ($.content = null));
        }),
    ...
    (function (e) {
        ...
        for (a in i)
          if (angular.isArray(i[a]))
            for (c = 0; c < i[a].length; c++)
              if (i[a][c].fn) for (s = 0; s < i[a][c].t; s++) t(a, i[a][c].fn(s, r), l, r);
              else t(a, i[a][c], l, r);
          else n(l, a, i[a]);
        o.appendChild(l);
      }
      ...
      function o(e, t) {
        return (e /= t / 2), 1 > e ? 0.5 * e * e * e : ((e -= 2), 0.5 * (e * e * e + 2));
      }
            ...
            function i() {
              if (!r.stop) {
                ...
                n(u, 'da', Math.max(Math.min(h, 188), 128)),
                  ...
                  n(u, 't', 'scale(' + d + ',1) translate(' + f + ',0) rotate(' + v + ',32,32)'),
                  (s += 4.1),
                  s > 359 && (s = 0),
      ...
      function (e, t, n) {
        ...
        (o.tabs = []),
          ...
          (o.showBar = function (e) {
            return (
              arguments.length &&
                (e ? t.removeClass('tabs-item-hide') : t.addClass('tabs-item-hide'), (c = !!e)),
              c
            );
          });
      },
        ...
        return {
          ...
          compile: function (e, o) {
            ...
            e.addClass('scroll-content ionic-scroll'),
              'false' != o.scroll
                ? ((a = f('<div class="scroll"></div>')), a.append(e.contents()), e.append(a))
      ...
      return {
        ...
        compile: function (t, n) {
          return (
            ...
            function (t, n, i, o) {
              o.optionsContainer ||
                ((o.optionsContainer = f(S)), o.$element.prepend(o.optionsContainer)),
      ...
      return function (e, t) {
        ...
        function i() {
          (!ionic.Platform.isAndroid() || ionic.Platform.isFullScreen) &&
            (t.css('bottom', ''), r && (r.scrollView.__container.style.bottom = ''));
        }
        ...
        return {
          ...
          link: function (n, i) {
            i.bind('click', function () {
              ...
              n &&
                (e.nextViewOptions({ historyRoot: !0, disableAnimate: !0, expire: 300 }),
                t(function () {
        ...
        return {
          ...
          compile: function (n, i) {
            ...
            i.ngClick || r.setAttribute('ng-click', '$ionicGoBack()'),
              ...
              (r.innerHTML = n.html() || '');
            for (var c, s, l, u, d = o(n[0]), f = 0; f < n[0].childNodes.length; f++)
              (c = n[0].childNodes[f]),
                1 === c.nodeType
                  ? o(c)
                    ? (d = !0)
            ...
            if (
              (!d &&
                h &&
                'none' !== h &&
                ((r.innerHTML = '<i class="icon ' + h + '"></i> ' + r.innerHTML),
              ...
              (p.className = 'back-text'),
                !l &&
                  e.backButton.text() &&
                  (p.innerHTML += '<span class="default-title">' + e.backButton.text() + '</span>'),
                !u &&
        ...
        return {
          ...
          compile: function (i, o) {
            function r(r, a, c, s) {
              function u(e) {
                0 !== s.getOpenAmount()
                  ? (s.close(), e.gesture.srcEvent.preventDefault(), (v = null), (g = null))
        ...
        function (e, t, n, i, o, r) {
          return {
              ...
              function (e, n, a) {
                ...
                var s = this,
                  ...
                  p = new ionic.views.Slider({
                    ...
                    callback: function (n) {
                      (e.currentSlide = n),
                        e.onSlideChanged({ index: e.currentSlide, $index: e.currentSlide }),
            ...
            link: function (t, i, o) {
              ...
              e.enabled(i, !1),
                l(o.showPager) || ((t.showPager = !0), r().toggleClass('hide', !1)),
                ...
                (this.update = function () {
                  t(function () {
                    if (o.__slider) {
                      ...
                      t > 10 && (e.showPager = !1),
                        o.__slider.activeIndex > t - 1 && o.__slider.slideTo(t - 1);
                    }
                  });
                }),
            ...
            return (
              ...
              function (o, r, a, l) {
                ...
                function p(n) {
                  n && u
                    ? (b ||
                        ...
                        (b = !0)),
                      i.viewEleIsActive(m, !0))
                    : b && m && (t.views.maxCache() > 0 ? i.viewEleIsActive(m, !1) : v());
                }
                function v() {
                ...
                var g,
                  ...
                  b = !1;
                (o.$tabSelected = !1),
                  n(o, a, { onSelect: '&', onDeselect: '&', title: '@', uiSref: '@', href: '@' }),
                  $.add(o),
                  o.$on('$destroy', function () {
