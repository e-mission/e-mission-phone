  ...
  (function (ionic) {
    ...
    ionic.Gestures.event = {
      ...
      collectEventData: function collectEventData(element, eventType, touches, ev) {
        ...
        if (
          ev.type.match(/mouse/) ||
          ionic.Gestures.PointerEvent.matchType(ionic.Gestures.POINTER_MOUSE, ev)
        ) {
    ...
    ionic.Gestures.utils = {
      ...
      isVertical: function isVertical(direction) {
        return (
          direction == ionic.Gestures.DIRECTION_UP || direction == ionic.Gestures.DIRECTION_DOWN
        );
      },
    ...
    ionic.Gestures.detection = {
      ...
      extendEventData: function extendEventData(ev) {
        ...
        if (
          startEv &&
          (ev.touches.length != startEv.touches.length || ev.touches === startEv.touches)
        ) {
          ...
          case ionic.Gestures.EVENT_MOVE:
            ...
            if (ev.drag_locked_to_axis && last_direction !== ev.direction) {
              ...
              if (ionic.Gestures.utils.isVertical(last_direction)) {
                ev.direction =
                  ev.deltaY < 0 ? ionic.Gestures.DIRECTION_UP : ionic.Gestures.DIRECTION_DOWN;
              } else {
                ev.direction =
                  ev.deltaX < 0 ? ionic.Gestures.DIRECTION_LEFT : ionic.Gestures.DIRECTION_RIGHT;
              }
            }
    ...
    var self = (ionic.Platform = {
      ...
      setPlatform: function (n) {
        if (typeof n != 'undefined' && n !== null && n.length) {
          ...
          platformName =
            (self.navigator.platform && navigator.platform.toLowerCase().split(' ')[0]) || '';
        }
      },
...
*/
  ...
  ionic.tap = {
    ...
    isDateInput: function (ele) {
      return (
        !!ele && ele.tagName == 'INPUT' && /^(date|time|datetime-local|month|week)$/i.test(ele.type)
      );
    },
  ...
  */
      ...
      __initEventHandlers: function () {
        ...
        self.touchMove = function (e) {
          ...
          if (
            !self.__hasStarted &&
            (ionic.tap.containsOrIsTextInput(e.target) || e.target.tagName === 'SELECT')
          ) {
      ...
      __resizeScrollbars: function () {
        ...
        if (self.__indicatorX) {
          var width = Math.max(
            Math.round((self.__clientWidth * self.__clientWidth) / self.__contentWidth),
            20,
          );
        ...
        if (self.__indicatorY) {
          var height = Math.max(
            Math.round((self.__clientHeight * self.__clientHeight) / self.__contentHeight),
            20,
          );
        ...
        if (self.__isDragging) {
          ...
          if (scale != null && self.options.zooming) {
            ...
            if (oldLevel !== level) {
              ...
              scrollTop =
                ((currentTouchTopRel + scrollTop) * level) / oldLevel - currentTouchTopRel;
  ...
  */
        ...
        if (self.options.bouncing) {
          ...
          if (scrollOutsideX !== 0) {
            var isHeadingOutwardsX =
              scrollOutsideX * self.__decelerationVelocityX <= self.__minDecelerationScrollLeft;
          ...
          if (scrollOutsideY !== 0) {
            var isHeadingOutwardsY =
              scrollOutsideY * self.__decelerationVelocityY <= self.__minDecelerationScrollTop;
      ...
      __initEventHandlers: function () {
        ...
        self.scrollChildIntoView = function (e) {
          ...
          if (!alreadyShrunk || changedKeyboardHeight) {
            ...
            if (
              !isPopover &&
              (ionic.Platform.isIOS() || ionic.Platform.isFullScreen || isInsetModal)
            ) {
              // if there are things below the scroll view account for them and
              // subtract them from the keyboard height when resizing
              // E - D                         E                         D
  ...
  (function (ionic) {
    ...
    SlideDrag.prototype.start = function (e) {
      ...
      offsetX =
        parseFloat(content.style[ionic.CSS.TRANSFORM].replace('translate3d(', '').split(',')[0]) ||
        0;
    ...
    ReorderDrag.prototype.drag = ionic.animationFrameThrottle(function (e) {
      ...
      if (this.scrollView) {
        ...
        var pixelsPastBottom =
          pageY + this._currentDrag.elementHeight / 2 - containerTop - container.offsetHeight;
    ...
    ionic.views.ListView = ionic.views.View.inherit({
      initialize: function (opts) {
        ...
        if (!self.itemHeight && self.listEl) {
          self.itemHeight =
            self.listEl.children[0] && parseInt(self.listEl.children[0].style.height, 10);
        }
  ...
  (function (ionic) {
    ...
    ionic.views.SideMenuContent = ionic.views.View.inherit({
      ...
      getTranslateX: function () {
        return parseFloat(
          this.el.style[ionic.CSS.TRANSFORM].replace('translate3d(', '').split(',')[0],
        );
      },
  ...
  (function () {
    ...
    var Swiper = function (container, params, _scope, $compile) {
      ...
      s.rtl =
        isH() &&
        (s.container[0].dir.toLowerCase() === 'rtl' || s.container.css('direction') === 'rtl');
      if (s.rtl) {
      ...
      s.updateSlidesSize = function () {
        ...
        var numFullColumns =
          slidesPerRow - (s.params.slidesPerColumn * slidesPerRow - s.slides.length);
        for (i = 0; i < s.slides.length; i++) {
          ...
          if (s.params.slidesPerView === 'auto') {
            ...
            slideSize =
              (s.size - (s.params.slidesPerView - 1) * spaceBetween) / s.params.slidesPerView;
            if (s.params.roundLengths) slideSize = round(slideSize);
        ...
        if (s.params.slidesPerColumn > 1) {
          ...
          s.virtualSize =
            Math.ceil(s.virtualSize / s.params.slidesPerColumn) - s.params.spaceBetween;
          s.wrapper.css({ width: s.virtualSize + s.params.spaceBetween + 'px' });
          if (s.params.centeredSlides) {
            newSlidesGrid = [];
        ...
        for (i = 0; i < s.slidesGrid.length; i++) {
          if (typeof s.slidesGrid[i + 1] !== 'undefined') {
            if (
              ...
              translate < s.slidesGrid[i + 1] - (s.slidesGrid[i + 1] - s.slidesGrid[i]) / 2
            ) {
              newActiveIndex = i;
      ...
      s.updateClasses = function () {
        s.slides.removeClass(
          s.params.slideActiveClass + ' ' + s.params.slideNextClass + ' ' + s.params.slidePrevClass,
        );
      ...
      if (window.navigator.pointerEnabled || window.navigator.msPointerEnabled) {
        (s.params.touchEventsTarget === 'container' ? s.container : s.wrapper).addClass(
          'swiper-wp8-' + s.params.direction,
        );
      }
      ...
      s.initEvents = function (detach) {
        ...
        var touchEventsTarget =
          s.params.touchEventsTarget === 'container' ? s.container[0] : s.wrapper[0];
          ...
          if (s.params.loop) {
            ...
            if (s.params.centeredSlides) {
              if (
                ...
                slideToIndex > s.slides.length - s.loopedSlides + s.params.slidesPerView / 2
              ) {
                s.fixLoop();
        ...
        if (diff > 0 && currentTranslate > s.minTranslate()) {
          ...
          if (s.params.resistance)
            currentTranslate =
              s.minTranslate() -
              1 +
              Math.pow(-s.minTranslate() + startTranslate + diff, s.params.resistanceRatio);
          ...
          if (s.params.resistance)
            currentTranslate =
              s.maxTranslate() +
              1 -
              Math.pow(s.maxTranslate() - startTranslate - diff, s.params.resistanceRatio);
        }
        ...
        for (i = 0; i < s.slidesGrid.length; i += s.params.slidesPerGroup) {
          if (typeof s.slidesGrid[i + s.params.slidesPerGroup] !== 'undefined') {
            ...
            if (currentPos >= s.slidesGrid[i]) {
              stopIndex = i;
              groupSize =
                s.slidesGrid[s.slidesGrid.length - 1] - s.slidesGrid[s.slidesGrid.length - 2];
            }
          }
        }
      ...
      s.updateLoop = function () {
        ...
        if (angular.element(currentSlide).hasClass(s.params.slideDuplicateClass)) {
          ...
          for (var i = 0; i < slides.length; i++) {
            if (
              !angular.element(slides[i]).hasClass(s.params.slideDuplicateClass) &&
              angular.element(slides[i]).attr('data-swiper-slide-index') === swiperSlideIndex
            ) {
      ...
      s.fixLoop = function () {
        ...
        //Fix For Positive Oversliding
          ...
          (s.params.slidesPerView === 'auto' && s.activeIndex >= s.loopedSlides * 2) ||
            ...
            for (var i = 0; i < s.slides.length; i++) {
              ...
              if (s.params.cube.slideShadows) {
                ...
                if (shadowBefore.length === 0) {
                  shadowBefore = $(
                    '<div class="swiper-slide-shadow-' + (isH() ? 'left' : 'top') + '"></div>',
                  );
                  slide.append(shadowBefore);
                }
                if (shadowAfter.length === 0) {
                  shadowAfter = $(
                    '<div class="swiper-slide-shadow-' + (isH() ? 'right' : 'bottom') + '"></div>',
                  );
          ...
          setTranslate: function () {
            ...
            for (var i = 0, length = s.slides.length; i < length; i++) {
              ...
              var offsetMultiplier =
                ((center - slideOffset - slideSize / 2) / slideSize) * s.params.coverflow.modifier;
          ...
          if (s.params.lazyLoadingInPrevNext) {
            if (s.params.slidesPerView > 1) {
              ...
              for (
                ...
                i < s.activeIndex + s.params.slidesPerView + s.params.slidesPerView;
                i++
              ) {
                if (s.slides[i]) s.lazy.loadImageInSlide(i);
              }
        ...
        onTransitionStart: function () {
          if (s.params.lazyLoading) {
            if (
              ...
              (!s.params.lazyLoadingOnTransitionStart && !s.lazy.initialImageLoaded)
            ) {
              s.lazy.load();
            }
          }
      ...
      s.scrollbar = {
        ...
        setDragPosition: function (e) {
          ...
          var pointerPosition = isH()
            ...
            : e.pageY || e.clientY;
          var position =
            pointerPosition - sb.track.offset()[isH() ? 'left' : 'top'] - sb.dragSize / 2;
        ...
        setTranslate: function (translate, byController) {
          ...
          function setControlledTranslate(c) {
            ...
            if (!controlledTranslate || s.params.controlBy === 'container') {
              multiplier =
                (c.maxTranslate() - c.minTranslate()) / (s.maxTranslate() - s.minTranslate());
        ...
        initPagination: function () {
          if (
            ...
            s.bullets.each(function () {
              ...
              s.a11y.addLabel(
                bullet,
                s.params.paginationBulletMessage.replace(/{{index}}/, bullet.index() + 1),
              );
            });
          }
        },
        ...
        if (
          ...
          if (openPercent === 0) {
            ...
            var openPixel = Math.round(
              (openPercent / 100) * this.track.offsetWidth - this.handle.offsetWidth,
            );
